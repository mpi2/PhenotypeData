...
@ComponentScan(basePackages = {"org.mousephenotype.cda.loads.create.releasenotes", "org.mousephenotype.cda.db.dao", "org.mousephenotype.cda.solr.service"},
        excludeFilters = {
                @ComponentScan.Filter(type = FilterType.ASSIGNABLE_TYPE, value = {GwasDAO.class, ReferenceDAO.class})})
public class ReleaseAnalyticsConfig {
