 ...
 *
 * Implements a LineMapper&lt;FieldSet&gt; for use by any item reader wanting to parse a file containing tab-separated
 * column data.
 */
public class LineMapperFieldSet  implements LineMapper<FieldSet> {
    @Override
