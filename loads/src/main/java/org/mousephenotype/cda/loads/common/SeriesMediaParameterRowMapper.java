 ...
 */
public class SeriesMediaParameterRowMapper implements RowMapper<SeriesMediaParameter> {
         ...
         */
        @Override
        public SeriesMediaParameter mapRow(ResultSet rs, int rowNum) throws SQLException {
            SeriesMediaParameter row = new SeriesMediaParameter();
