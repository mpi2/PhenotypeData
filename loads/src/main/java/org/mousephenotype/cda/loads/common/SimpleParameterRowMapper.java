 ...
 */
public class SimpleParameterRowMapper implements RowMapper<SimpleParameter> {
         ...
         */
        @Override
        public SimpleParameter mapRow(ResultSet rs, int rowNum) throws SQLException {
            SimpleParameter row = new SimpleParameter();
