...
@Configuration
@ComponentScan("org.mousephenotype.cda.loads.dataimport.dcc")
...
public class DccConfigApp {
    ...
    @Bean(name = "dccLoaderUtils")
    public DccSqlUtils dccLoaderUtils() {
        return new DccSqlUtils(new NamedParameterJdbcTemplate(dcc()));
    }
