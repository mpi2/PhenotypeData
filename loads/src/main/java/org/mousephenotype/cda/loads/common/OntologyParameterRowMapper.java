 ...
 */
public class OntologyParameterRowMapper implements RowMapper<OntologyParameter> {
         ...
         */
        @Override
        public OntologyParameter mapRow(ResultSet rs, int rowNum) throws SQLException {
            OntologyParameter row = new OntologyParameter();
