...
public class AlleleProcessorGenopheno extends AlleleProcessorAbstract {
    ...
    public AlleleProcessorGenopheno(Map<String, GenomicFeature> genomicFeatures, Map<String, OntologyTerm> featureTypes) {
    ...
    public Allele process(Allele allele) throws Exception {
        ...
        if (allele != null) {
            allele.setName(SqlLoaderUtils.NAME_NOT_SPECIFIED);
        }
