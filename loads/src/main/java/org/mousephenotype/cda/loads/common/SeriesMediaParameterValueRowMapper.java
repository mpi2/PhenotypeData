 ...
 */
public class SeriesMediaParameterValueRowMapper implements RowMapper<SeriesMediaParameterValue> {
     ...
     */
    @Override
    public SeriesMediaParameterValue mapRow(ResultSet rs, int rowNum) throws SQLException {
        SeriesMediaParameterValue row = new SeriesMediaParameterValue();
