...
INSERT INTO `phenotyped_colony` (`colony_name`, `es_cell_name`, `gf_acc`, `gf_db_id`, `allele_symbol`, `background_strain_name`, `production_centre_organisation_id`, `production_consortium_project_id`, `phenotyping_centre_organisation_id`, `phenotyping_consortium_project_id`, `cohort_production_centre_organisation_id`)
VALUES
('EPD0038_2_B10_10026',NULL,'MGI:98970',(SELECT @MGI_DB_ID),'Xbp1<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('DNase-X',NULL,'MGI:109628',(SELECT @MGI_DB_ID),'Dnase1l1<tm1Dkfz>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('CMHD-TM_N00324P0_T20D4',NULL,'MGI:2158736',(SELECT @MGI_DB_ID),'Senp3<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('Wrnip1tm1a KO',NULL,'MGI:1926153',(SELECT @MGI_DB_ID),'Wrnip1<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Vwde',NULL,'MGI:2685313',(SELECT @MGI_DB_ID),'Vwde<tm1Icmb>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('EUC0050E03',NULL,'MGI:87880',(SELECT @MGI_DB_ID),'Aco2<Gt(EUC0050e03)Hmgu>','129P2/OlaHsd',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('EPD0038_2_B10_10557',NULL,'MGI:98970',(SELECT @MGI_DB_ID),'Xbp1<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Tmc1Tmc1<dn>',NULL,'MGI:2151016',(SELECT @MGI_DB_ID),'Tmc1<dn>','STOCK Tmc1<dn>',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('EPD0002_2_B07',NULL,'MGI:2150037',(SELECT @MGI_DB_ID),'Mta1<tm1a(EUCOMM)Wtsi>','129/SvEv',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Magi2Magi2<tm1Grnt>',NULL,'MGI:1354953',(SELECT @MGI_DB_ID),'Magi2<tm1Grnt>','129S5;129P2',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('#4',NULL,'MGI:104735',(SELECT @MGI_DB_ID),'Gt(ROSA)26Sor<tm1(FLP1)Dym>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Prkab1Prkab1<Gt(RRR454)Byg>',NULL,'MGI:1336167',(SELECT @MGI_DB_ID),'Prkab1<Gt(RRR454)Byg>','CBA/Ca;129P2',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Arl4',NULL,'MGI:99437',(SELECT @MGI_DB_ID),'Arl4a<tm1Asch>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('EUC0027G03',NULL,'MGI:2142567',(SELECT @MGI_DB_ID),'Arhgef18<Gt(EUC0027g03)Hmgu>','129P2/OlaHsd',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Nox4',NULL,'MGI:1354184',(SELECT @MGI_DB_ID),'Nox4<tm1.1Hwsc>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Asxl tm1a KO',NULL,'MGI:2684063',(SELECT @MGI_DB_ID),'Asxl1<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Matn1Matn1<tm1Goe>',NULL,'MGI:106591',(SELECT @MGI_DB_ID),'Matn1<tm1Goe>','C57BL/6JTyr;C57BL/6;129S5',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('EPD0059_3_A06',NULL,'MGI:1914084',(SELECT @MGI_DB_ID),'Acot13<tm1a(EUCOMM)Wtsi>','C57BL/6NTacDen',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('B6.Cg-Sfrp2<I153N>/H',NULL,'MGI:108078',(SELECT @MGI_DB_ID),'Sfrp2<I153N>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Elk4Elk4<tm1a(EUCOMM)Wtsi/H>',NULL,'MGI:102853',(SELECT @MGI_DB_ID),'Elk4<tm1a(EUCOMM)Wtsi>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Ren1Ren1<Ren-1c Enhancer KO>',NULL,'MGI:97898',(SELECT @MGI_DB_ID),'Ren1<Ren-1c Enhancer KO>','C57BL/6JIco',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('CMHD-TM_N00020P0_T5C11',NULL,'MGI:2652885',(SELECT @MGI_DB_ID),'Tbc1d2<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('EUCE0233_A03',NULL,'MGI:102790',(SELECT @MGI_DB_ID),'Rab18<Gt(EUCE0233a03)Hmgu>','129P2/OlaHsd',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('HEPD0634_1_D03',NULL,'MGI:97005',(SELECT @MGI_DB_ID),'Mmp12<tm1a(EUCOMM)Hmgu>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('C3H.Cg-Fbxo11<Jf>/H',NULL,'MGI:2147134',(SELECT @MGI_DB_ID),'Fbxo11<Jf>','C3H/HeH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('B6Dnk;129P2-HBP1<Gt(EUCJ0053g09)>/H',NULL,'MGI:894659',(SELECT @MGI_DB_ID),'Hbp1<Gt(EUCJ0053g09)>Hmgu','C57BL/6Dnk',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('CMHD-TM_N01174P0_T28D11',NULL,'MGI:1915987',(SELECT @MGI_DB_ID),'Angel1<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('HST012',NULL,'MGI:102674',(SELECT @MGI_DB_ID),'Umod<urehr4>','C3HeB/FeJ',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('EUC0054A05',NULL,'MGI:2137706',(SELECT @MGI_DB_ID),'Actn1<Gt(EUC0054a05)Hmgu>','129P2/OlaHsd',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('129-Smo<tm1Amc>/H',NULL,'MGI:108075',(SELECT @MGI_DB_ID),'Smo<tm1Amc>','129S9/SvEvH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Myo7aMyo7a<Hdb>',NULL,'MGI:104510',(SELECT @MGI_DB_ID),'Myo7a<Hdb>','C3HeB/FeJ',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Ankrd13aAnkrd13a<Gt(RRH308)Byg>',NULL,'MGI:1915670',(SELECT @MGI_DB_ID),'Ankrd13a<Gt(RRH308)Byg>','CBA/Ca;129P2',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('C57BL/6J-Ucp1<m1H>/H',NULL,'MGI:98894',(SELECT @MGI_DB_ID),'Ucp1<m1H>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('EUCJ0004_F10',NULL,'MGI:97316',(SELECT @MGI_DB_ID),'Nfya<Gt(EUCJ0004f10)Hmgu>','C57BL/6NTacDen',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('HST009',NULL,'MGI:103150',(SELECT @MGI_DB_ID),'Slc12a1<urehr3>','C3HeB/FeJ',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('CMHD-TM_N00006P0_T6F5',NULL,'MGI:1917274',(SELECT @MGI_DB_ID),'Mcm10<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('DLG3',NULL,'MGI:1353651',(SELECT @MGI_DB_ID),'Gnl3<Gt(W062C05)Wrst>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('EPD0001_3_E04',NULL,'MGI:1349766',(SELECT @MGI_DB_ID),'Brd7<tm3a(EUCOMM)Wtsi>','129/SvEv',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('EUCJ0079D10',NULL,'MGI:1201409',(SELECT @MGI_DB_ID),'Pknox1<Gt(EUCJ0079d10)Hmgu>','C57BL/6NTacDen',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('C3H.Cg-Ankrd11<Yod>/H',NULL,'MGI:1924337',(SELECT @MGI_DB_ID),'nkrd11<Yod>','C3H/HeH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('HEPD0527_5_A04',NULL,'MGI:2444491',(SELECT @MGI_DB_ID),'Heatr3<tm1a(EUCOMM)Hmgu>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Ptdsr',NULL,'MGI:1858910',(SELECT @MGI_DB_ID),'Jmjd6<tm1.1Gbf>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Rassf1Rassf1<tm1.2Brd>',NULL,'MGI:1928386',(SELECT @MGI_DB_ID),'Rassf1<tm1.2Brd>','C57BL/6JTyr;129S5',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('clone 1',NULL,'MGI:104874 ',(SELECT @MGI_DB_ID),'Akt2<tm1Wcs>','129/SvEv',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('129/SvEv-Gnas<tm1Jop>/H',NULL,'MGI:95777',(SELECT @MGI_DB_ID),'Gnas<tm1Jop>','129S9/SvEvH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('ALI14',NULL,'MGI:97616',(SELECT @MGI_DB_ID),'Plcg2<Ali14>','C3HeB/FeJ',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Miz1',NULL,'MGI:1096566',(SELECT @MGI_DB_ID),'Pias2<Gt(pT1Betageo)1Ruiz>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('EPD0019_1_D07',NULL,'MGI:2444748',(SELECT @MGI_DB_ID),'Chd7<tm2a(EUCOMM)Wtsi>','129S5;C57BL/6N',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Ube3bUbe3b<Gt(RRJ142)Byg>',NULL,'MGI:1891295',(SELECT @MGI_DB_ID),'Ube3b<Gt(RRJ142)Byg>','CBA/Ca;129P2',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('B6.129P2-Mro<tm1H>/H',NULL,'MGI:2152817',(SELECT @MGI_DB_ID),'Mro<tm1H>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Cidec tm1a KO',NULL,'MGI:95585',(SELECT @MGI_DB_ID),'Cidec<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('CMHD-TM_N00135P0_T22G9',NULL,'MGI:2654703',(SELECT @MGI_DB_ID),'Otud7b<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('C3H.Cg-Ptk7<chz>/H',NULL,'MGI:1918711',(SELECT @MGI_DB_ID),'Ptk7<chz>','C3H/HeH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('CMHD-TM_N00016P0_T5D5',NULL,'MGI:1916960',(SELECT @MGI_DB_ID),'Arap1<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('B6.Cg-Sfrp5<Q27STOP>/H',NULL,'MGI:1860298',(SELECT @MGI_DB_ID),'Sfrp5<Q27STOP>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('ApoeApoe<tm1Unc>',NULL,'MGI:88057',(SELECT @MGI_DB_ID),'Apoe<tm1Unc>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('HEPD0527_4_D08',NULL,'MGI:1350921',(SELECT @MGI_DB_ID),'Fkbp9<tm1a(EUCOMM)Hmgu>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('B6.129-Ptch1<tm1Mps>/JH',NULL,'MGI:105373',(SELECT @MGI_DB_ID),'Ptch1<tm1Mps>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('129S9/SvEvH-Nespas<tm3Jop>/H',NULL,'MGI:1861674',(SELECT @MGI_DB_ID),'Gnas/Nespas<tm2.1Jop>','129S9/SvEvH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('C.Cg-Bfc/H',NULL,'MGI:88276',(SELECT @MGI_DB_ID),'Ctnnb1<Bfc>','BALB/cAnNCrl',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('C.Cg-Celsr1<Crsh>/H',NULL,'MGI:1100883',(SELECT @MGI_DB_ID),'Celsr1<Crsh>','BALB/cAnNCrl',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('EUC0047A08',NULL,'MGI:1917329',(SELECT @MGI_DB_ID),'Golm1<Gt(EUC0047a08)Hmgu>','129P2/OlaHsd',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('EPD0002_3_G03',NULL,'MGI:1278322',(SELECT @MGI_DB_ID),'Epc1<tm1a(EUCOMM)Wtsi>','129/SvEv',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('C3H.A-Vangl2<Lp>/H',NULL,'MGI:2135272',(SELECT @MGI_DB_ID),'Vangl2<Lp>','C3H/HeH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('NCAM1',NULL,'MGI:97281',(SELECT @MGI_DB_ID),'Ncam1<tm1Cgn>','C57BL/6JIco',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Deltagen_407',NULL,'MGI:2449205',(SELECT @MGI_DB_ID),'Nr1d2<tm1Dgen>','B6J.129S2',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('N00007P0_T5B3',NULL,'MGI:88255',(SELECT @MGI_DB_ID),'Anxa6<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('CMHD-TM_N01605P1_T53C4',NULL,'MGI:2685003',(SELECT @MGI_DB_ID),'Zbtb45<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('Grin2aGrin2a<tm1Rsp>',NULL,'MGI:95820',(SELECT @MGI_DB_ID),'Grin2a<tm1Rsp>','C57BL/6JIco;129P2',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('CMHD-TM_N01539P1_T51C7',NULL,'MGI:1922075',(SELECT @MGI_DB_ID),'Senp6<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('Eya3',NULL,'MGI:109339',(SELECT @MGI_DB_ID),'Eya3<Gt(W096D02)Wrst>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('CMHD-TM_N00086P0_T24C7',NULL,'MGI:1914737',(SELECT @MGI_DB_ID),'Dhx40<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('EPD0001_3_G07',NULL,'MGI:98809',(SELECT @MGI_DB_ID),'Tpm1<tm1a(EUCOMM)Wtsi>','129/SvEv',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Aldh2Aldh2<tm1a(EUCOMM)Wtsi/Hmgu>',NULL,'MGI:99600',(SELECT @MGI_DB_ID),'Aldh2<tm1a(EUCOMM)Wtsi>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Nr1i2',NULL,'MGI:1337040',(SELECT @MGI_DB_ID),'Nr1i2','B6J.129S2',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Bin1_mut1',NULL,'MGI:108092',(SELECT @MGI_DB_ID),'Bin1_mut1','B6N.B6J.129S2',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Bin1_mut2',NULL,'MGI:108092',(SELECT @MGI_DB_ID),'Bin1_mut2','B6N.129S2.B6J',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Nr1h4',NULL,'MGI:1352464',(SELECT @MGI_DB_ID),'Nr1h4','B6J.129S2',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Nr6a1',NULL,'MGI:1352459',(SELECT @MGI_DB_ID),'Nr6a1','B6J.129S2',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('EUCJ004_F10',NULL,'MGI:97316',(SELECT @MGI_DB_ID),'Nfya','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Snx5',NULL,'MGI:1916428',(SELECT @MGI_DB_ID),'Snx5','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('NR1D1',NULL,'MGI:2444210',(SELECT @MGI_DB_ID),'Nr1d1','B6J.129S2',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Stard3',NULL,'MGI:1929618',(SELECT @MGI_DB_ID),'Stard3','B6N.129S2.B6J',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('STARD3NL',NULL,'MGI:1923455',(SELECT @MGI_DB_ID),'STARD3NL','B6N.129S2.B6J',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Emp3',NULL,'MGI:1098729',(SELECT @MGI_DB_ID),'Emp3','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Ncor2',NULL,'MGI:1337080',(SELECT @MGI_DB_ID),'Ncor2','B6J.129S2',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Strap',NULL,'MGI:1329037',(SELECT @MGI_DB_ID),'Strap','B6J.B6N',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Gbx1',NULL,'MGI:95667',(SELECT @MGI_DB_ID),'Gbx1','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Tbp2',NULL,'MGI:2684058',(SELECT @MGI_DB_ID),'Tbp2','B6J.129S2.B6N',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('March 7 targeted gene trap Cross 1',NULL,'MGI:1931053',(SELECT @MGI_DB_ID),'March7','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Nr2b3',NULL,'MGI:98216',(SELECT @MGI_DB_ID),'Rxrg','B6J.129S2',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Gpt2',NULL,'MGI:1915391',(SELECT @MGI_DB_ID),'Gpt2','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Sighted C3H',NULL,'MGI:97525',(SELECT @MGI_DB_ID),'Pde6b','C3H/HeH',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Nr3c2',NULL,'MGI:99459',(SELECT @MGI_DB_ID),'Nr3c2','B6J.129S2',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Net',NULL,'MGI:101762',(SELECT @MGI_DB_ID),'Elk3','B6J.B6N',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Aste1',NULL,'MGI:1913845',(SELECT @MGI_DB_ID),'Aste1','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Nr0b2',NULL,'MGI:1346344',(SELECT @MGI_DB_ID),'Nr0b2','B6J.129S2',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Ttll12',NULL,'MGI:3039573',(SELECT @MGI_DB_ID),'Ttll12','B6J.B6N',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('PJA1',NULL,'MGI:1101765',(SELECT @MGI_DB_ID),'PJA1','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Dnm2',NULL,'MGI:109547',(SELECT @MGI_DB_ID),'Dnm2','Balb/c.129S2',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Insl5',NULL,'MGI:1346085',(SELECT @MGI_DB_ID),'Insl5','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('EPD0518_6_B02',NULL,'MGI:95405',(SELECT @MGI_DB_ID),'Ephx1','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Rere',NULL,'MGI:2683486',(SELECT @MGI_DB_ID),'Rere','B6J.B6N',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('B6129S8-Tc(Hsa21)1TybEmcf/H',NULL,'MGI:3814702',(SELECT @MGI_DB_ID),'Tc(Hsa21)1TybEmcf','Stock',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('B6.Cg-cub/H',NULL,'MGI:1890156',(SELECT @MGI_DB_ID),'Stx8<tm2a(EUCOMM)Wtsi>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Dll1_C3H_113',NULL,'MGI:104659',(SELECT @MGI_DB_ID),'Dll1<tm1Gos>','C3HeB/FeJ',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Dll1_C3H_10333',NULL,'MGI:104659',(SELECT @MGI_DB_ID),'Dll1<tm1Gos>','129SvJ-Iso',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Gsk3a',NULL,'MGI:2152453',(SELECT @MGI_DB_ID),'Gsk3a<not yet available>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Kcnip4',NULL,'MGI:1933131',(SELECT @MGI_DB_ID),'Kcnip4<not yet available>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('March 7 KO (Cross 2)',NULL,'MGI:1931053',(SELECT @MGI_DB_ID),'MARCH7<not yet available>','C57BL''C3H.C-Mecom<Jbo>/H ''/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('C.Cg-Ostes/H',NULL,'MGI:3688249',(SELECT @MGI_DB_ID),'Ostes','BALB/cAnNCrl',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Phex',NULL,'MGI:107489',(SELECT @MGI_DB_ID),'Phex<not yet available>','C3HeB/FeJ',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('VMP1',NULL,'MGI:1923159',(SELECT @MGI_DB_ID),'Vmp1<not yet available>','C57BL/6NTacDen',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Ifitm1_1F4',NULL,'MGI:1915963',(SELECT @MGI_DB_ID),'Ifitm1<not yet assigned>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'HMGU'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'HMGU'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'HMGU')),
('RHBDL5-AG2',NULL,'MGI:2442473',(SELECT @MGI_DB_ID),'Rhbdf2<not yet available>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Myo7aMyo7a<sh1-6J>',NULL,'MGI:104510',(SELECT @MGI_DB_ID),'Myo7a<sh1-6J>','AKR/J;C57BLKS/J',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Atp2b2Atp2b2<Obv>',NULL,'MGI:105368',(SELECT @MGI_DB_ID),'Atp2b2<Obv>','C3HeB/FeJ',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Dlg4Dlg4<tm1Grnt>',NULL,'MGI:1277959',(SELECT @MGI_DB_ID),'Dlg4<tm1Grnt>','C57BL/6JIco;129P2',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Ttll4Ttll4<tm1a(EUCOMM)Wtsi/H>',NULL,'MGI:1914784',(SELECT @MGI_DB_ID),'Ttll4<tm1a(EUCOMM)Wtsi>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('WhrnWhrn<wi>',NULL,'MGI:2682003',(SELECT @MGI_DB_ID),'Whrn<wi>','STOCK Whrn<wi>',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Git2Git2<Gt(XG510)Byg>',NULL,'MGI:1347053',(SELECT @MGI_DB_ID),'Git2<Gt(XG510)Byg>','CBA/Ca;129P2',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Secisbp2Secisbp2<tm1a(EUCOMM)Wtsi/H>',NULL,'MGI:1922670',(SELECT @MGI_DB_ID),'Secisbp2<tm1a(EUCOMM)Wtsi>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Chd7Chd7<Whi>',NULL,'MGI:2444748',(SELECT @MGI_DB_ID),'Chd7<Whi>','C3HeB/FeJ',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Clk1Clk1<tm1a(EUCOMM)Wtsi/Ics>',NULL,'MGI:107403',(SELECT @MGI_DB_ID),'Clk1<tm1a(EUCOMM)Wtsi>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Dlg2Dlg2<tm1Dsb>',NULL,'MGI:1344351',(SELECT @MGI_DB_ID),'Dlg2<tm1Dsb>','C57BL/6JIco',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Ifitm3Ifitm3<tm1Masu>',NULL,'MGI:1913391',(SELECT @MGI_DB_ID),'Ifitm3<tm1Masu>','C57BL/6JIco;C57BL/6JTyr;129P2',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Entpd1Entpd1<tm1a(EUCOMM)Wtsi/Hmgu>',NULL,'MGI:102805',(SELECT @MGI_DB_ID),'Entpd1<tm1a(EUCOMM)Wtsi>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('NfyaNfya<Gt(EUCJ0004f10)Hmgu>',NULL,'MGI:97316',(SELECT @MGI_DB_ID),'Nfya<Gt(EUCJ0004f10)Hmgu>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('129S9/SvEvH-Ablim1<tm1H>/H',NULL,'MGI:1194500',(SELECT @MGI_DB_ID),'Ablim1<tm1H>','129S9/SvEvH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('129P2/OlaHsd-Fbxl3<Gt(CB0226)Wtsi>/H',NULL,'MGI:1354702',(SELECT @MGI_DB_ID),'Fbxl3<Gt(CB0226)Wtsi>','129P2/OlaHsd',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('C3H.C-Mecom<Jbo>/H',NULL,'MGI:95457',(SELECT @MGI_DB_ID),'Mecom<Jbo>','C3H/HeH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('C3H.B6-Tulp3<hhkr>/H',NULL,'MGI:1329045',(SELECT @MGI_DB_ID),'Tulp3<hhkr>','C3H/HeH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('C3H.C-Trpc3<Mwk>/H',NULL,'MGI:109526',(SELECT @MGI_DB_ID),'Trpc3<Mwk>','C3H/HeH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('129P2/OlaHsd-Tpcn1<Gt(XG716)Byg>/H',NULL,'MGI:2182472',(SELECT @MGI_DB_ID),'Tpcn1<Gt(XG716)Byg>','129P2/OlaHsd',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('B6.Cg-Sfrp2<C50F>/H',NULL,'MGI:108078',(SELECT @MGI_DB_ID),'Sfrp2<C50F>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('129P2/OlaHsd-Map3k1<Gt(YTC001)Byg>/H',NULL,'MGI:1346872',(SELECT @MGI_DB_ID),'Map3k1<Gt(YTC001)Byg>','129P2/OlaHsd',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('B6.129-Kcnj16<tm1Sjtu>/H',NULL,'MGI:1314842',(SELECT @MGI_DB_ID),'Kcnj16<tm1Sjtu>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('mPtpg',NULL,'MGI:1921802',(SELECT @MGI_DB_ID),'Nipal3<tm1Pbfd>','129SV',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('EPS8',NULL,'MGI:104684',(SELECT @MGI_DB_ID),'Eps8<tm1Ppdf>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('FoxP2 delta exon7',NULL,'MGI:2148705',(SELECT @MGI_DB_ID),'Foxp2<tm2.1Woen>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Abcb4',NULL,'MGI:97569',(SELECT @MGI_DB_ID),'Abcb4<tm1Bor>','FVB/NJ',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Fam63aFam63a<tm1a(EUCOMM)Wtsi/Ics>',NULL,'MGI:1922257',(SELECT @MGI_DB_ID),'Fam63a<tm1a(EUCOMM)Wtsi>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Eyl',NULL,'MGI:1100498',(SELECT @MGI_DB_ID),'Pitx3<eyl>','C3H/NHG',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('B6.129-Sfrp1<tm1Aksh>',NULL,'MGI:892014',(SELECT @MGI_DB_ID),'Sfrp1<tm1Aksh>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Tp53',NULL,'MGI:1926609',(SELECT @MGI_DB_ID),'Trp53inp1<tm1Acar>','129/Sv_C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('HEPD0546_1_F01',NULL,'MGI:2685397',(SELECT @MGI_DB_ID),'Rc3h1<tm1a(EUCOMM)Hmgu>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('IFIT-2',NULL,'MGI:99449',(SELECT @MGI_DB_ID),'Ifit2<tm1.1Ebsb>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('CMHD-TM_N00105P0_T28A8',NULL,'MGI:1202301',(SELECT @MGI_DB_ID),'Itch<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('Tmem45b',NULL,'MGI:2384574',(SELECT @MGI_DB_ID),'Tmem45b<tm1.1Hsue>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('DKK3',NULL,'MGI:1354952',(SELECT @MGI_DB_ID),'Dkk3<tm1Cni>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('T181',NULL,'MGI:1924104',(SELECT @MGI_DB_ID),'Gper1<tm1Dgen>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('1',NULL,'MGI:1336167',(SELECT @MGI_DB_ID),'Prkab1<tm1a(KOMP)Wtsi>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('CMHD-TM_N00005P0_T11G1',NULL,'MGI:1933401',(SELECT @MGI_DB_ID),'Zfp202<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('EPD060_1_B12',NULL,'MGI:104681',(SELECT @MGI_DB_ID),'Hgs<tm1a(EUCOMM)Wtsi>','C57BL/6NTacDen',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('B6.129P2-Vnn1<tm1Pna>/H',NULL,'MGI:108395',(SELECT @MGI_DB_ID),'Vnn1<tm1Pna>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('MARCH9-KO_NOT_OSN',NULL,'MGI:2446144',(SELECT @MGI_DB_ID),'March9<tm1a(EUCOMM)Wtsi>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Myo6Myo6<sv>',NULL,'MGI:104785',(SELECT @MGI_DB_ID),'Myo6<sv>','C57BL/6JIco;C57BL/10',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('129-Nespas<tm1Jop>/H',NULL,'MGI:1861674',(SELECT @MGI_DB_ID),'Nespas<tm1Jop>','129S8/SvEv-Gpi1<c>/NimrH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Vimentin',NULL,'MGI:98932',(SELECT @MGI_DB_ID),'Vim<tm2Cba>','129/SvPas',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('CMHD-TM_N00343P0_T21F5',NULL,'MGI:1916221',(SELECT @MGI_DB_ID),'Tamm41<tm1(NCOM)Cmhd>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'CMHD')),
('Cin85',NULL,'MGI:1889583',(SELECT @MGI_DB_ID),'Sh3kbp1<tm1Ivdi>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('EPD0028_5_G01',NULL,'MGI:108086',(SELECT @MGI_DB_ID),'Hdac1<tm1a(EUCOMM)Wtsi>','C57BL/6NTacDen',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('DEA3',NULL,'MGI:2151016',(SELECT @MGI_DB_ID),'Tmc1<Bth>','C3HeB/FeJ',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Glut8',NULL,'MGI:1860103',(SELECT @MGI_DB_ID),'Slc2a8<tm1.1Asch>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('C3H.Cg-Celsr1<Scy>/H',NULL,'MGI:1100883',(SELECT @MGI_DB_ID),'Celsr1<Scy>','C3H/HeH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Usp6nl',NULL,'MGI:2138893',(SELECT @MGI_DB_ID),'Usp6nl<tm1Ppdf>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Cadm1Cadm1<tm1.2Brd>',NULL,'MGI:1889272',(SELECT @MGI_DB_ID),'Cadm1<tm1.2Brd>','C57BL/6JIco;C57BL/6JTyr;129S5',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Rhbdl4-/-',NULL,'MGI:1924117',(SELECT @MGI_DB_ID),'Rhbdd1<tm1.1Mfm>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Abcb4_Balb/cJ',NULL,'MGI:97569',(SELECT @MGI_DB_ID),'Abcb4<tm1Bor>','BALB/cByJ',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('129P2/OlaHsd-Tpcn2<Gt(YHD437)Byg>/H',NULL,'MGI:2385297',(SELECT @MGI_DB_ID),'Tpcn2<Gt(YHD437)Byg>','129P2/OlaHsd',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('EPD0033_3_C09',NULL,'MGI:1336167',(SELECT @MGI_DB_ID),'Prkab1<tm1a(KOMP)Wtsi>','C57BL/6N',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('EUCJ0019C12',NULL,'MGI:104662',(SELECT @MGI_DB_ID),'Pml<Gt(EUCJ0019c12)Hmgu>','C57BL/6NTacDen',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('EUC BL6-FP00042B07',NULL,'MGI:1934229',(SELECT @MGI_DB_ID),'Setdb1<tm1a(EUCOMM)Wtsi>','C57BL/6NTacDen',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('NADH',NULL,'MGI:1918611',(SELECT @MGI_DB_ID),'Aifm2<tm1Avm>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Matn3Matn3<tm1Brd>',NULL,'MGI:1328350',(SELECT @MGI_DB_ID),'Matn3<tm1Brd>','C57BL/6JTyr;C57BL/6;129S5',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Kctd10Kctd10<Gt(RRG305)Byg>',NULL,'MGI:2141207',(SELECT @MGI_DB_ID),'Kctd10<Gt(RRG305)Byg>','CBA/Ca;129P2',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Grxcr1Grxcr1<tde>',NULL,'MGI:3577767',(SELECT @MGI_DB_ID),'Grxcr1<pi-tde>','STOCK Grxcr1<tde>',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('ENSMUSG00000065586ENSMUSG00000065586<Dmdo>',NULL,'MGI:3619440',(SELECT @MGI_DB_ID),'Mir96<Dmdo>','C3HeB/FeJ',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
('Stx8tm3a KO',NULL,'MGI:1890156',(SELECT @MGI_DB_ID),'Stx8<tm2a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Ino80e tm1a KO',NULL,'MGI:2141881',(SELECT @MGI_DB_ID),'Ino80e<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('Dmbt1',NULL,'MGI:106210',(SELECT @MGI_DB_ID),'Dmbt1<tm1Janm>','C57BL/6',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('B6.129-Sfrp2<tm1Aksh>',NULL,'MGI:108078',(SELECT @MGI_DB_ID),'Sfrp2<tm1Aksh>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('M076C04',NULL,'MGI:1915372',(SELECT @MGI_DB_ID),'Nkain4<Gt(M076C04)Vmel>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('C1orf37',NULL,'MGI:1914729',(SELECT @MGI_DB_ID),'Tg(TMEM183B)1Pbo','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('EPD0288_3_A08',NULL,'MGI:2429409',(SELECT @MGI_DB_ID),'Afm<tm1a(KOMP)Wtsi>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('Dll1<C413Y>',NULL,'MGI:104659',(SELECT @MGI_DB_ID),'Dll1<m1Mhda>','C3HeB/FeJ',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('FoxP2',NULL,'MGI:2148705',(SELECT @MGI_DB_ID),'Foxp2<tm1Woen>','C57BL/6J',(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Hmgu')),
('129-Shh<tm1Chg>/H',NULL,'MGI:98297',(SELECT @MGI_DB_ID),'Shh<tm1Chg>','129S9/SvEvH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('HEPD0527_2_D03',NULL,'MGI:2685493',(SELECT @MGI_DB_ID),'Pla2g4f<tm1a(EUCOMM)Hmgu>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Ics')),
('129S9/SvEvH-Nodal<tm1Rob>/H',NULL,'MGI:97359',(SELECT @MGI_DB_ID),'Nodal<tm1Rob>','129S9/SvEvH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
('Hmx3Hmx3<hx>',NULL,'MGI:107160',(SELECT @MGI_DB_ID),'Hmx3<tm1Ebo>','STOCK Hmx3<hx>',(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'Wtsi')),
...
/*!40000 ALTER TABLE `genes_secondary_project` DISABLE KEYS */;
...
INSERT INTO `genes_secondary_project` VALUES ('MGI:2441734','idg','GPCRs'),('MGI:2441732','idg','GPCRs'),('MGI:2681280','idg','GPCRs'),('MGI:2681253','idg','GPCRs'),('MGI:2681259','idg','GPCRs'),('MGI:2681298','idg','GPCRs'),('MGI:108418','idg','GPCRs'),('MGI:1202299','idg','GPCRs'),('MGI:2686146','idg','GPCRs'),('MGI:102967','idg','GPCRs'),('MGI:2441803','idg','GPCRs'),('MGI:1097709','idg','GPCRs'),('MGI:2685341','idg','GPCRs'),('MGI:1329003','idg','GPCRs'),('MGI:1347010','idg','GPCRs'),('MGI:1917605','idg','GPCRs'),('MGI:1354372','idg','GPCRs'),('MGI:2681278','idg','GPCRs'),('MGI:2681273','idg','GPCRs'),('MGI:2159637','idg','GPCRs'),('MGI:106912','idg','GPCRs'),('MGI:3606604','idg','GPCRs'),('MGI:108082','idg','GPCRs'),('MGI:2672983','idg','GPCRs'),('MGI:3645524','idg','GPCRs'),('MGI:1345190','idg','GPCRs'),('MGI:2676315','idg','GPCRs'),('MGI:1277167','idg','GPCRs'),('MGI:1333809','idg','GPCRs'),('MGI:1933113','idg','GPCRs'),('MGI:109248','idg','GPCRs'),('MGI:1927851','idg','GPCRs'),('MGI:2681218','idg','GPCRs'),('MGI:2685145','idg','GPCRs'),('MGI:891989','idg','GPCRs'),('MGI:2685071','idg','GPCRs'),('MGI:105372','idg','GPCRs'),('MGI:1346334','idg','GPCRs'),('MGI:2136761','idg','GPCRs'),('MGI:2681308','idg','GPCRs'),('MGI:1929676','idg','GPCRs'),('MGI:2135882','idg','GPCRs'),('MGI:2182926','idg','GPCRs'),('MGI:2677633','idg','GPCRs'),('MGI:1916157','idg','GPCRs'),('MGI:1918361','idg','GPCRs'),('MGI:1919112','idg','GPCRs'),('MGI:1927596','idg','GPCRs'),('MGI:2441827','idg','GPCRs'),('MGI:2442046','idg','GPCRs'),('MGI:2442043','idg','GPCRs'),('MGI:2668437','idg','GPCRs'),('MGI:101909','idg','GPCRs'),('MGI:2441719','idg','GPCRs'),('MGI:1934135','idg','GPCRs'),('MGI:2155249','idg','GPCRs'),('MGI:1924846','idg','GPCRs'),('MGI:2685955','idg','GPCRs'),('MGI:2653880','idg','GPCRs'),('MGI:2681312','idg','GPCRs'),('MGI:2441887','idg','GPCRs'),('MGI:3033145','idg','GPCRs'),('MGI:2681210','idg','GPCRs'),('MGI:2685222','idg','GPCRs'),('MGI:2441671','idg','GPCRs'),('MGI:3643278','idg','GPCRs'),('MGI:1920260','idg','GPCRs'),('MGI:2441884','idg','GPCRs'),('MGI:3033139','idg','GPCRs'),('MGI:2135884','idg','GPCRs'),('MGI:2681256','idg','GPCRs'),('MGI:2685211','idg','GPCRs'),('MGI:1859670','idg','GPCRs'),('MGI:1935037','idg','GPCRs'),('MGI:107859','idg','GPCRs'),('MGI:3041203','idg','GPCRs'),('MGI:1858235','idg','GPCRs'),('MGI:1914418','idg','GPCRs'),('MGI:2446854','idg','GPCRs'),('MGI:1891250','idg','GPCRs'),('MGI:1927653','idg','GPCRs'),('MGI:2443628','idg','GPCRs'),('MGI:1277106','idg','GPCRs'),('MGI:2681304','idg','GPCRs'),('MGI:3525078','idg','GPCRs'),('MGI:96283','idg','GPCRs'),('MGI:1918021','idg','GPCRs'),('MGI:107193','idg','GPCRs'),('MGI:1925499','idg','GPCRs'),('MGI:2441758','idg','GPCRs'),('MGI:2441890','idg','GPCRs'),('MGI:2451244','idg','GPCRs'),('MGI:2441843','idg','GPCRs'),('MGI:1934133','idg','GPCRs'),('MGI:2182728','idg','GPCRs'),('MGI:2685213','idg','GPCRs'),('MGI:2182928','idg','GPCRs'),('MGI:892973','idg','GPCRs'),('MGI:2441950','idg','GPCRs'),('MGI:3527454','idg','GPCRs'),('MGI:2685519','idg','GPCRs'),('MGI:2681302','idg','GPCRs'),('MGI:2441837','idg','GPCRs'),('MGI:2685887','idg','GPCRs'),('MGI:2147529','idg','GPCRs'),('MGI:2441872','idg','GPCRs'),('MGI:2441992','idg','GPCRs'),('MGI:1315214','idg','GPCRs'),('MGI:1926076','idg','GPCRs'),('MGI:2681247','idg','GPCRs'),('MGI:3033115','idg','GPCRs'),('MGI:3588270','idg','GPCRs'),('MGI:2685995','idg','GPCRs'),('MGI:2685076','idg','GPCRs'),('MGI:3527452','idg','GPCRs'),('MGI:3033095','idg','GPCRs'),('MGI:3821888','idg','GPCRs'),('MGI:3033098','idg','GPCRs'),('MGI:3033148','idg','GPCRs'),('MGI:2445052','idg','Kinases'),('MGI:1921428','idg','Kinases'),('MGI:2385204','idg','Kinases'),('MGI:1918885','idg','Kinases'),('MGI:3026984','idg','Kinases'),('MGI:2685008','idg','Kinases'),('MGI:1347357','idg','Kinases'),('MGI:1344404','idg','Kinases'),('MGI:2652869','idg','Kinases'),('MGI:98904','idg','Kinases'),('MGI:2147036','idg','Kinases'),('MGI:109584','idg','Kinases'),('MGI:894318','idg','Kinases'),('MGI:1289172','idg','Kinases'),('MGI:1276121','idg','Kinases'),('MGI:97517','idg','Kinases'),('MGI:1330292','idg','Kinases'),('MGI:1914128','idg','Kinases'),('MGI:2449492','idg','Kinases'),('MGI:1289230','idg','Kinases'),('MGI:2148775','idg','Kinases'),('MGI:2652894','idg','Kinases'),('MGI:3587025','idg','Kinases'),('MGI:3583944','idg','Kinases'),('MGI:2137630','idg','Kinases'),('MGI:1196223','idg','Kinases'),('MGI:1891766','idg','Kinases'),('MGI:1917172','idg','Kinases'),('MGI:1891338','idg','Kinases'),('MGI:1336167','idg','Kinases'),('MGI:1349436','idg','Kinases'),('MGI:1891638','idg','Kinases'),('MGI:1889336','idg','Kinases'),('MGI:1339656','idg','Kinases'),('MGI:1931744','idg','Kinases'),('MGI:1927552','idg','Kinases'),('MGI:1352500','idg','Kinases'),('MGI:1346023','idg','Kinases'),('MGI:1922250','idg','Kinases'),('MGI:1921385','idg','Kinases'),('MGI:2442399','idg','Kinases'),('MGI:2442403','idg','Kinases'),('MGI:1921903','idg','Kinases'),('MGI:1931787','idg','Kinases'),('MGI:2685557','idg','Kinases'),('MGI:1913837','idg','Kinases'),('MGI:1917675','idg','Kinases'),('MGI:2142227','idg','Kinases'),('MGI:2679420','idg','Kinases'),('MGI:2385213','idg','Kinases'),('MGI:2444559','idg','Kinases'),('MGI:2442190','idg','Kinases'),('MGI:1333822','idg','Kinases'),('MGI:107930','idg','Kinases'),('MGI:1924735','idg','Kinases'),('MGI:1921622','idg','Kinases'),('MGI:1346879','idg','Kinases'),('MGI:1929914','idg','Kinases'),('MGI:1330300','idg','Kinases'),('MGI:1330302','idg','Kinases'),('MGI:1330301','idg','Kinases'),('MGI:3528383','idg','Kinases'),('MGI:3039582','idg','Kinases'),('MGI:2442276','idg','Kinases'),('MGI:1098670','idg','Kinases'),('MGI:2152419','idg','Kinases'),('MGI:1920014','idg','Kinases'),('MGI:2683541','idg','Kinases'),('MGI:2388285','idg','Kinases'),('MGI:1098551','idg','Kinases'),('MGI:2652845','idg','Kinases'),('MGI:1916211','idg','Kinases'),('MGI:107929','idg','Kinases'),('MGI:1201675','idg','Kinases'),('MGI:2448506','idg','Kinases'),('MGI:2388073','idg','Kinases'),('MGI:1329027','idg','Kinases'),('MGI:2441683','idg','Kinases'),('MGI:2151224','idg','Kinases'),('MGI:2136459','idg','Kinases'),('MGI:2444188','idg','Kinases'),('MGI:97594','idg','Kinases'),('MGI:894279','idg','Kinases'),('MGI:1347557','idg','Kinases'),('MGI:2685924','idg','Kinases'),('MGI:96840','idg','Kinases'),('MGI:1913266','idg','Kinases'),('MGI:1858227','idg','Kinases'),('MGI:2685925','idg','Kinases'),('MGI:1203730','idg','Kinases'),('MGI:2385336','idg','Kinases'),('MGI:3027899','idg','Kinases'),('MGI:2448549','idg','Kinases'),('MGI:108411','idg','Kinases'),('MGI:1351326','idg','Kinases'),('MGI:2152214','idg','Kinases'),('MGI:2142824','idg','Kinases'),('MGI:1918341','idg','Kinases'),('MGI:1928487','idg','Kinases'),('MGI:2387464','idg','Kinases'),('MGI:1918590','idg','Kinases'),('MGI:1195261','idg','Kinases'),('MGI:2443419','idg','Kinases'),('MGI:97579','idg','Kinases'),('MGI:1918349','idg','Kinases'),('MGI:2679274','idg','Kinases'),('MGI:2155779','idg','Kinases'),('MGI:1890645','idg','Kinases'),('MGI:1920955','idg','Kinases'),('MGI:2388268','idg','Kinases'),('MGI:97518','idg','Kinases'),('MGI:88547','idg','Kinases'),('MGI:97601','idg','Kinases'),('MGI:2443413','idg','Kinases'),('MGI:2685045','idg','Kinases'),('MGI:1858204','idg','Kinases'),('MGI:1922857','idg','Kinases'),('MGI:1344375','idg','Kinases'),('MGI:2384296','idg','Kinases'),('MGI:2446159','idg','Kinases'),('MGI:2660884','idg','Kinases'),('MGI:97576','idg','Kinases'),('MGI:894676','idg','Kinases'),('MGI:1920831','idg','Kinases'),('MGI:1914050','idg','Kinases'),('MGI:1918294','idg','Kinases'),('MGI:1914799','idg','Ion channels'),('MGI:103301','idg','Ion channels'),('MGI:1859165','idg','Ion channels'),('MGI:1933131','idg','Ion channels'),('MGI:2146607','idg','Ion channels'),('MGI:87886','idg','Ion channels'),('MGI:2445160','idg','Ion channels'),('MGI:102965','idg','Ion channels'),('MGI:2685489','idg','Ion channels'),('MGI:106921','idg','Ion channels'),('MGI:2652846','idg','Ion channels'),('MGI:1918882','idg','Ion channels'),('MGI:1932376','idg','Ion channels'),('MGI:1913983','idg','Ion channels'),('MGI:87895','idg','Ion channels'),('MGI:96671','idg','Ion channels'),('MGI:1298234','idg','Ion channels'),('MGI:99418','idg','Ion channels'),('MGI:1098718','idg','Ion channels'),('MGI:102522','idg','Ion channels'),('MGI:1347049','idg','Ion channels'),('MGI:1859639','idg','Ion channels'),('MGI:2385186','idg','Ion channels'),('MGI:1338890','idg','Ion channels'),('MGI:1913272','idg','Ion channels'),('MGI:3588203','idg','Ion channels'),('MGI:1202403','idg','Ion channels'),('MGI:2143897','idg','Ion channels'),('MGI:2442845','idg','Ion channels'),('MGI:1098804','idg','Ion channels'),('MGI:1859168','idg','Ion channels'),('MGI:104696','idg','Ion channels'),('MGI:1921821','idg','Ion channels'),('MGI:3612244','idg','Ion channels'),('MGI:95751','idg','Ion channels'),('MGI:2157091','idg','Ion channels'),('MGI:1916704','idg','Ion channels'),('MGI:2387404','idg','Ion channels'),('MGI:2443317','idg','Ion channels'),('MGI:2159566','idg','Ion channels'),('MGI:107497','idg','Ion channels'),('MGI:1932374','idg','Ion channels'),('MGI:87891','idg','Ion channels'),('MGI:87890','idg','Ion channels'),('MGI:95624','idg','Ion channels'),('MGI:2684139','idg','Ion channels'),('MGI:95749','idg','Ion channels'),('MGI:2684043','idg','Ion channels'),('MGI:3609260','idg','Ion channels'),('MGI:88295','idg','Ion channels'),('MGI:96670','idg','Ion channels'),('MGI:2664099','idg','Ion channels'),('MGI:95617','idg','Ion channels'),('MGI:95618','idg','Ion channels'),('MGI:95619','idg','Ion channels'),('MGI:3043288','idg','Ion channels'),('MGI:2156184','idg','Ion channels'),('MGI:2685197','idg','Ion channels'),('MGI:894644','idg','Ion channels'),('MGI:2385894','idg','Ion channels'),('MGI:2664670','idg','Ion channels'),('MGI:2664668','idg','Ion channels'),('MGI:95625','idg','Ion channels'),('MGI:1859167','idg','Ion channels'),('MGI:109239','idg','Ion channels'),('MGI:1889006','idg','Ion channels'),('MGI:1889007','idg','Ion channels'),('MGI:1924118','idg','Ion channels'),('MGI:1924627','idg','Ion channels'),('MGI:1310000','idg','Ion channels'),('MGI:1929259','idg','Ion channels'),('MGI:3694646','idg','Ion channels'),('MGI:103156','idg','Ion channels'),('MGI:1206582','idg','Ion channels'),('MGI:2139758','idg','Ion channels'),('MGI:1890615','idg','Ion channels'),('MGI:1336208','idg','Ion channels'),('MGI:1917912','idg','Ion channels'),('MGI:1921674','idg','Ion channels'),('MGI:1930643','idg','Ion channels'),('MGI:1914748','idg','Ion channels'),('MGI:1933993','idg','Ion channels'),('MGI:103307','idg','Ion channels'),('MGI:1929813','idg','Ion channels'),('MGI:2442632','idg','Ion channels'),('MGI:1915051','idg','Ion channels'),('MGI:2387597','idg','Ion channels'),('MGI:1918881','idg','Ion channels'),('MGI:1197019','idg','Ion channels'),('MGI:1197011','idg','Ion channels'),('MGI:2157946','idg','Ion channels'),('MGI:95816','idg','Ion channels'),('MGI:1298211','idg','Ion channels'),('MGI:2443082','idg','Ion channels'),('MGI:96664','idg','Ion channels'),('MGI:96663','idg','Ion channels'),('MGI:95750','idg','Ion channels'),('MGI:1917607','idg','Ion channels'),('MGI:2663923','idg','Ion channels'),('MGI:1861899','idg','Ion channels'),('MGI:1858231','idg','Ion channels'),('MGI:2384820','idg','Ion channels'),('MGI:95812','idg','Ion channels'),('MGI:1341841','idg','Ion channels'),('MGI:2669035','idg','Ion channels'),('MGI:2669033','idg','Ion channels'),('MGI:87893','idg','Ion channels'),('MGI:2139744','idg','Ion channels'),('MGI:2139790','idg','Ion channels');
