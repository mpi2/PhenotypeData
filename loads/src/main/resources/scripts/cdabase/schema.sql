...
VALUES
	...
	('EPD0013_1_G11_10613',NULL,'MGI:1927664',(SELECT @MGI_DB_ID),'Sirt2<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',   (SELECT id FROM organisation WHERE name = 'H'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'H'),(SELECT @EUMODIC_PROJECT_ID)),
	...
	('EPD0033_3_F04_10955',NULL,'MGI:1924054',(SELECT @MGI_DB_ID),'Kdm4c<tm1a(KOMP)Wtsi>','C57BL/6NTac',(SELECT id FROM organisation WHERE name = 'H'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'H'),(SELECT @EUMODIC_PROJECT_ID)),
	('EPD0039_1_B01_10470',NULL,'MGI:2156003',(SELECT @MGI_DB_ID),'Snip1<tm1a(EUCOMM)Wtsi>','C57BL/6Dnk',(SELECT id FROM organisation WHERE name = 'H'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'H'),(SELECT @EUMODIC_PROJECT_ID)),
