...
INSERT INTO missing_colony_id (colony_id, log_level, reason) VALUES
  ...
  ('CBLT', -1, 'Known missing 3i colony id'),
  ('CBSC', -1, 'Known missing 3i colony id'),
  ('CRES', -1, 'Known missing 3i colony id'),
  ('DABG', -1, 'Known missing 3i colony id'),
  ('DADN', -1, 'Known missing 3i colony id'),
  ('DAEE', -1, 'Known missing 3i colony id'),
  ('DAFA', -1, 'Known missing 3i colony id'),
  ('DAGX', -1, 'Known missing 3i colony id'),
  ('DAJW', -1, 'Known missing 3i colony id'),
  ('DAKD', -1, 'Known missing 3i colony id'),
  ('DAKE', -1, 'Known missing 3i colony id'),
  ('EUDS', -1, 'Known missing 3i colony id'),
  ('GBBA', -1, 'Known missing 3i colony id'),
  ('GDAA', -1, 'Known missing 3i colony id'),
  ('GDBF', -1, 'Known missing 3i colony id'),
  ('GFMA', -1, 'Known missing 3i colony id'),
  ('KMAA', -1, 'Known missing 3i colony id'),
  ('KMAB', -1, 'Known missing 3i colony id'),
  ('KMAC', -1, 'Known missing 3i colony id'),
  ('LRGO', -1, 'Known missing 3i colony id'),
  ('MAMC', -1, 'Known missing 3i colony id'),
  ('MAOR', -1, 'Known missing 3i colony id'),
  ('MCDB', -1, 'Known missing 3i colony id'),
  ('MCKP', -1, 'Known missing 3i colony id'),
  ('MCWG', -1, 'Known missing 3i colony id'),
  ('MCYA', -1, 'Known missing 3i colony id'),
  ('MDAD', -1, 'Known missing 3i colony id'),
  ('MDDA', -1, 'Known missing 3i colony id'),
  ('MDDH', -1, 'Known missing 3i colony id'),
  ('MDEK', -1, 'Known missing 3i colony id'),
  ('MDET', -1, 'Known missing 3i colony id'),
  ('MDEU', -1, 'Known missing 3i colony id'),
  ('MDEW', -1, 'Known missing 3i colony id'),
  ('MDEX', -1, 'Known missing 3i colony id'),
  ('MDEZ', -1, 'Known missing 3i colony id'),
  ('MDFA', -1, 'Known missing 3i colony id'),
  ('MDJW', -1, 'Known missing 3i colony id'),
  ('MEQL', -1, 'Known missing 3i colony id'),
  ('MEQT', -1, 'Known missing 3i colony id'),
  ('MEVA', -1, 'Known missing 3i colony id'),
  ('MEXT', -1, 'Known missing 3i colony id'),
  ('MEYF', -1, 'Known missing 3i colony id'),
  ('MFEU', -1, 'Known missing 3i colony id'),
  ('MFQK', -1, 'Known missing 3i colony id'),
  ('MFQP', -1, 'Known missing 3i colony id'),
  ('MGFA', -1, 'Known missing 3i colony id'),
  ('MGHC', -1, 'Known missing 3i colony id'),
  ('MGLN', -1, 'Known missing 3i colony id'),
  ('MGPQ', -1, 'Known missing 3i colony id'),
  ('MGQF', -1, 'Known missing 3i colony id'),
  ('MGSE', -1, 'Known missing 3i colony id'),
  ('MGSJ', -1, 'Known missing 3i colony id'),
  ('MGSK', -1, 'Known missing 3i colony id'),
  ('MHAA', -1, 'Known missing 3i colony id'),
  ('MHBL', -1, 'Known missing 3i colony id'),
  ('MHDP', -1, 'Known missing 3i colony id'),
  ('MHDV', -1, 'Known missing 3i colony id'),
  ('MHEM', -1, 'Known missing 3i colony id'),
  ('MHEX', -1, 'Known missing 3i colony id'),
  ('MHFJ', -1, 'Known missing 3i colony id'),
  ('MHGH', -1, 'Known missing 3i colony id'),
  ('MHHP', -1, 'Known missing 3i colony id'),
  ('MHJF', -1, 'Known missing 3i colony id'),
  ('MKPT', -1, 'Known missing 3i colony id'),
  ('MOAA', -1, 'Known missing 3i colony id'),
  ('MOAB', -1, 'Known missing 3i colony id'),
  ('MOAC', -1, 'Known missing 3i colony id'),
  ('MOAD', -1, 'Known missing 3i colony id'),
  ('MOAE', -1, 'Known missing 3i colony id'),
  ('MOAG', -1, 'Known missing 3i colony id'),
  ('MOAM', -1, 'Known missing 3i colony id'),
  ('MOAS', -1, 'Known missing 3i colony id'),
  ('MOEA', -1, 'Known missing 3i colony id'),
  ('MPSD', -1, 'Known missing 3i colony id'),
  ('MSKO', -1, 'Known missing 3i colony id'),
  ('MTKB', -1, 'Known missing 3i colony id'),
...
insert into external_db(id, name, short_name, version, version_date) values(23, 'The Infection and Immunity Immunophenotyping (3i) consortium', '3i', '2014-11-07', '2014-11-07');
...
SELECT id FROM project WHERE name = 'MGP' INTO @MGP_PROJECT_ID;
SELECT id FROM project WHERE name = '3i' INTO @THREEI_PROJECT_ID;
SELECT id FROM external_db WHERE short_name = 'MGI' INTO @MGI_DB_ID;

SELECT id FROM organisation WHERE name = 'Wtsi' INTO @ORGANISATION_ID_WTSI;
SELECT id FROM organisation WHERE name = 'Ics' INTO @ORGANISATION_ID_ICS;
SELECT id FROM organisation WHERE name = 'Hmgu' INTO @ORGANISATION_ID_HMGU;
SELECT id FROM organisation WHERE name = 'MRC Harwell' INTO @ORGANISATION_ID_MRCHARWELL;
SELECT id FROM organisation WHERE name = 'CMHD' INTO @ORGANISATION_ID_CMHD;
...
INSERT INTO genes_secondary_project VALUES ('MGI:101908', 'idg', 'GPCR'), ('MGI:101909', 'idg', 'GPCR'), ('MGI:102522', 'idg', 'Ion Channel'), ('MGI:102965', 'idg', 'Ion Channel'), ('MGI:102967', 'idg', 'GPCR'), ('MGI:103156', 'idg', 'Ion Channel'), ('MGI:103301', 'idg', 'Ion Channel'), ('MGI:103307', 'idg', 'Ion Channel'), ('MGI:104696', 'idg', 'Ion Channel'), ('MGI:106912', 'idg', 'GPCR'), ('MGI:106921', 'idg', 'Ion Channel'), ('MGI:107193', 'idg', 'GPCR'), ('MGI:107497', 'idg', 'Ion Channel'), ('MGI:107859', 'idg', 'GPCR'), ('MGI:107929', 'idg', 'Kinase'), ('MGI:107930', 'idg', 'Kinase'), ('MGI:108031', 'idg', 'GPCR'), ('MGI:108082', 'idg', 'GPCR'), ('MGI:108418', 'idg', 'GPCR'), ('MGI:108495', 'idg', 'Ion Channel'), ('MGI:109239', 'idg', 'Ion Channel'), ('MGI:109248', 'idg', 'GPCR'), ('MGI:109545', 'idg', 'GPCR'), ('MGI:109584', 'idg', 'Kinase'), ('MGI:1098272', 'idg', 'Kinase'), ('MGI:1098551', 'idg', 'Kinase'), ('MGI:1098670', 'idg', 'Kinase'), ('MGI:1098718', 'idg', 'Ion Channel'), ('MGI:1098802', 'idg', 'Kinase'), ('MGI:1098804', 'idg', 'Ion Channel'), ('MGI:1195261', 'idg', 'Kinase'), ('MGI:1196223', 'idg', 'Kinase'), ('MGI:1196464', 'idg', 'GPCR'), ('MGI:1197011', 'idg', 'Ion Channel'), ('MGI:1197019', 'idg', 'Ion Channel'), ('MGI:1201675', 'idg', 'Kinase'), ('MGI:1202299', 'idg', 'GPCR'), ('MGI:1203730', 'idg', 'Kinase'), ('MGI:1206582', 'idg', 'Ion Channel'), ('MGI:1276121', 'idg', 'Kinase'), ('MGI:1277167', 'idg', 'GPCR'), ('MGI:1278336', 'idg', 'Kinase'), ('MGI:1289172', 'idg', 'Kinase'), ('MGI:1289230', 'idg', 'Kinase'), ('MGI:1298224', 'idg', 'Kinase'), ('MGI:1298234', 'idg', 'Ion Channel'), ('MGI:1310000', 'idg', 'Ion Channel'), ('MGI:1313297', 'idg', 'GPCR'), ('MGI:1314873', 'idg', 'Kinase'), ('MGI:1314882', 'idg', 'Kinase'), ('MGI:1315214', 'idg', 'GPCR'), ('MGI:1330292', 'idg', 'Kinase'), ('MGI:1330300', 'idg', 'Kinase'), ('MGI:1330301', 'idg', 'Kinase'), ('MGI:1330302', 'idg', 'Kinase'), ('MGI:1330861', 'idg', 'Kinase'), ('MGI:1333877', 'idg', 'GPCR'), ('MGI:1336208', 'idg', 'Ion Channel'), ('MGI:1338890', 'idg', 'Ion Channel'), ('MGI:1339656', 'idg', 'Kinase'), ('MGI:1341841', 'idg', 'Ion Channel'), ('MGI:1341865', 'idg', 'Kinase'), ('MGI:1344371', 'idg', 'Kinase'), ('MGI:1344404', 'idg', 'Kinase'), ('MGI:1345190', 'idg', 'GPCR'), ('MGI:1346023', 'idg', 'Kinase'), ('MGI:1346334', 'idg', 'GPCR'), ('MGI:1346879', 'idg', 'Kinase'), ('MGI:1347049', 'idg', 'Ion Channel'), ('MGI:1347095', 'idg', 'GPCR'), ('MGI:1347095', 'idg', 'GPCR'), ('MGI:1347357', 'idg', 'Kinase'), ('MGI:1347557', 'idg', 'Kinase'), ('MGI:1347559', 'idg', 'Kinase'), ('MGI:1349436', 'idg', 'Kinase'), ('MGI:1351326', 'idg', 'Kinase'), ('MGI:1354372', 'idg', 'GPCR'), ('MGI:1858204', 'idg', 'Kinase'), ('MGI:1858227', 'idg', 'Kinase'), ('MGI:1858231', 'idg', 'Ion Channel'), ('MGI:1859165', 'idg', 'Ion Channel'), ('MGI:1859167', 'idg', 'Ion Channel'), ('MGI:1859168', 'idg', 'Ion Channel'), ('MGI:1859670', 'idg', 'GPCR'), ('MGI:1860085', 'idg', 'Enzyme'), ('MGI:1889006', 'idg', 'Ion Channel'), ('MGI:1889007', 'idg', 'Ion Channel'), ('MGI:1889336', 'idg', 'Kinase'), ('MGI:1890220', 'idg', 'GPCR'), ('MGI:1890615', 'idg', 'Ion Channel'), ('MGI:1890645', 'idg', 'Kinase'), ('MGI:1890646', 'idg', 'Kinase'), ('MGI:1891250', 'idg', 'GPCR'), ('MGI:1891338', 'idg', 'Kinase'), ('MGI:1891638', 'idg', 'Kinase'), ('MGI:1891766', 'idg', 'Kinase'), ('MGI:1913272', 'idg', 'Ion Channel'), ('MGI:1913983', 'idg', 'Ion Channel'), ('MGI:1914128', 'idg', 'Kinase'), ('MGI:1914295', 'idg', 'Kinase'), ('MGI:1914418', 'idg', 'GPCR'), ('MGI:1914490', 'idg', 'Kinase'), ('MGI:1914676', 'idg', 'Kinase'), ('MGI:1914748', 'idg', 'Ion Channel'), ('MGI:1914799', 'idg', 'Ion Channel'), ('MGI:1914799', 'idg', 'Ion Channel'), ('MGI:1915051', 'idg', 'Ion Channel'), ('MGI:1915919', 'idg', 'Kinase'), ('MGI:1916151', 'idg', 'GPCR'), ('MGI:1916157', 'idg', 'GPCR'), ('MGI:1916211', 'idg', 'Kinase'), ('MGI:1916704', 'idg', 'Ion Channel'), ('MGI:1916812', 'idg', 'Kinase'), ('MGI:1917172', 'idg', 'Kinase'), ('MGI:1917605', 'idg', 'GPCR'), ('MGI:1917607', 'idg', 'Ion Channel'), ('MGI:1917675', 'idg', 'Kinase'), ('MGI:1917912', 'idg', 'Ion Channel'), ('MGI:1917943', 'idg', 'GPCR'), ('MGI:1918021', 'idg', 'GPCR'), ('MGI:1918294', 'idg', 'Kinase'), ('MGI:1918341', 'idg', 'Kinase'), ('MGI:1918349', 'idg', 'Kinase'), ('MGI:1918361', 'idg', 'GPCR'), ('MGI:1918473', 'idg', 'GPCR'), ('MGI:1918590', 'idg', 'Kinase'), ('MGI:1918882', 'idg', 'Ion Channel'), ('MGI:1918885', 'idg', 'Kinase'), ('MGI:1919112', 'idg', 'GPCR'), ('MGI:1919363', 'idg', 'Kinase'), ('MGI:1919837', 'idg', 'Kinase'), ('MGI:1920014', 'idg', 'Kinase'),('MGI:1920260', 'idg', 'GPCR'), ('MGI:1920334', 'idg', 'Kinase'), ('MGI:1920831', 'idg', 'Kinase'), ('MGI:1920955', 'idg', 'Kinase'), ('MGI:1921385', 'idg', 'Kinase'), ('MGI:1921387', 'idg', 'Kinase'), ('MGI:1921428', 'idg', 'Kinase'), ('MGI:1921622', 'idg', 'Kinase'), ('MGI:1921674', 'idg', 'Ion Channel'), ('MGI:1921903', 'idg', 'Kinase'), ('MGI:1922250', 'idg', 'Kinase'), ('MGI:1922857', 'idg', 'Kinase'), ('MGI:1923020', 'idg', 'Kinase'), ('MGI:1924139', 'idg', 'Kinase'), ('MGI:1924627', 'idg', 'Ion Channel'), ('MGI:1924735', 'idg', 'Kinase'), ('MGI:1924846', 'idg', 'GPCR'), ('MGI:1925064', 'idg', 'Kinase'), ('MGI:1925499', 'idg', 'GPCR'), ('MGI:1925584', 'idg', 'Kinase'), ('MGI:1925810', 'idg', 'GPCR'), ('MGI:1926076', 'idg', 'GPCR'), ('MGI:1927552', 'idg', 'Kinase'), ('MGI:1927596', 'idg', 'GPCR'), ('MGI:1927653', 'idg', 'GPCR'), ('MGI:1927851', 'idg', 'GPCR'), ('MGI:1928487', 'idg', 'Kinase'), ('MGI:1928503', 'idg', 'GPCR'), ('MGI:1929509', 'idg', 'GPCR'), ('MGI:1929676', 'idg', 'GPCR'), ('MGI:1929813', 'idg', 'Ion Channel'), ('MGI:1929914', 'idg', 'Kinase'), ('MGI:1930643', 'idg', 'Ion Channel'), ('MGI:1931787', 'idg', 'Kinase'), ('MGI:1932374', 'idg', 'Ion Channel'), ('MGI:1932376', 'idg', 'Ion Channel'), ('MGI:1933113', 'idg', 'GPCR'), ('MGI:1933131', 'idg', 'Ion Channel'), ('MGI:1933383', 'idg', 'GPCR'), ('MGI:1933736', 'idg', 'GPCR'), ('MGI:1933993', 'idg', 'Ion Channel'), ('MGI:1934129', 'idg', 'GPCR'), ('MGI:1934133', 'idg', 'GPCR'), ('MGI:1934134', 'idg', 'GPCR'), ('MGI:1934135', 'idg', 'GPCR'), ('MGI:1934157', 'idg', 'Kinase'), ('MGI:1934950', 'idg', 'Kinase'), ('MGI:1935037', 'idg', 'GPCR'), ('MGI:2135882', 'idg', 'GPCR'), ('MGI:2135884', 'idg', 'GPCR'), ('MGI:2135937', 'idg', 'Kinase'), ('MGI:2136459', 'idg', 'Kinase'), ('MGI:2136761', 'idg', 'GPCR'), ('MGI:2137630', 'idg', 'Kinase'), ('MGI:2138162', 'idg', 'Kinase'), ('MGI:2139758', 'idg', 'Ion Channel'), ('MGI:2139790', 'idg', 'Ion Channel'), ('MGI:2142227', 'idg', 'Kinase'), ('MGI:2142824', 'idg', 'Kinase'), ('MGI:2143897', 'idg', 'Ion Channel'), ('MGI:2145349', 'idg', 'Kinase'), ('MGI:2146607', 'idg', 'Ion Channel'), ('MGI:2147036', 'idg', 'Kinase'), ('MGI:2147529', 'idg', 'GPCR'), ('MGI:2148775', 'idg', 'Kinase'), ('MGI:2151224', 'idg', 'Kinase'), ('MGI:2152214', 'idg', 'Kinase'), ('MGI:2152419', 'idg', 'Kinase'), ('MGI:2155249', 'idg', 'GPCR'), ('MGI:2155779', 'idg', 'Kinase'), ('MGI:2156184', 'idg', 'Ion Channel'), ('MGI:2157091', 'idg', 'Ion Channel'), ('MGI:2157946', 'idg', 'Ion Channel'), ('MGI:2178445', 'idg', 'GPCR'), ('MGI:2181726', 'idg', 'GPCR'), ('MGI:2182465', 'idg', 'Kinase'), ('MGI:2182728', 'idg', 'GPCR'), ('MGI:2182926', 'idg', 'GPCR'), ('MGI:2182928', 'idg', 'GPCR'), ('MGI:2384296', 'idg', 'Kinase'), ('MGI:2384789', 'idg', 'Non-IDG'), ('MGI:2384820', 'idg', 'Ion Channel'), ('MGI:2384823', 'idg', 'GPCR'), ('MGI:2385017', 'idg', 'Kinase'), ('MGI:2385186', 'idg', 'Ion Channel'), ('MGI:2385204', 'idg', 'Kinase'), ('MGI:2385213', 'idg', 'Kinase'), ('MGI:2385307', 'idg', 'Kinase'), ('MGI:2385336', 'idg', 'Kinase'), ('MGI:2385894', 'idg', 'Ion Channel'), ('MGI:2387404', 'idg', 'Ion Channel'), ('MGI:2387597', 'idg', 'Ion Channel'), ('MGI:2387609', 'idg', 'Non-IDG'), ('MGI:2387995', 'idg', 'Kinase'), ('MGI:2388073', 'idg', 'Kinase'), ('MGI:2388268', 'idg', 'Kinase'), ('MGI:2388285', 'idg', 'Kinase'), ('MGI:2441671', 'idg', 'GPCR'), ('MGI:2441674', 'idg', 'GPCR'), ('MGI:2441683', 'idg', 'Kinase'), ('MGI:2441719', 'idg', 'GPCR'), ('MGI:2441732', 'idg', 'GPCR'), ('MGI:2441734', 'idg', 'GPCR'), ('MGI:2441758', 'idg', 'GPCR'), ('MGI:2441763', 'idg', 'GPCR'), ('MGI:2441803', 'idg', 'GPCR'), ('MGI:2441827', 'idg', 'GPCR'), ('MGI:2441837', 'idg', 'GPCR'), ('MGI:2441841', 'idg', 'Kinase'), ('MGI:2441843', 'idg', 'GPCR'), ('MGI:2441872', 'idg', 'GPCR'), ('MGI:2441884', 'idg', 'GPCR'), ('MGI:2441887', 'idg', 'GPCR'), ('MGI:2441890', 'idg', 'GPCR'), ('MGI:2441992', 'idg', 'GPCR'), ('MGI:2442034', 'idg', 'GPCR'), ('MGI:2442043', 'idg', 'GPCR'), ('MGI:2442046', 'idg', 'GPCR'), ('MGI:2442190', 'idg', 'Kinase'), ('MGI:2442276', 'idg', 'Kinase'), ('MGI:2442399', 'idg', 'Kinase'), ('MGI:2442403', 'idg', 'Kinase'), ('MGI:2442632', 'idg', 'Ion Channel'), ('MGI:2442845', 'idg', 'Ion Channel'), ('MGI:2443082', 'idg', 'Ion Channel'), ('MGI:2443317', 'idg', 'Ion Channel'), ('MGI:2443413', 'idg', 'Kinase'), ('MGI:2443419', 'idg', 'Kinase'), ('MGI:2443628', 'idg', 'GPCR'), ('MGI:2444386', 'idg', 'Non-IDG'), ('MGI:2444559', 'idg', 'Kinase'), ('MGI:2444812', 'idg', 'Kinase'), ('MGI:2445052', 'idg', 'Kinase'), ('MGI:2445160', 'idg', 'Ion Channel'), ('MGI:2446854', 'idg', 'GPCR'), ('MGI:2448506', 'idg', 'Kinase'), ('MGI:2448549', 'idg', 'Kinase'), ('MGI:2448588', 'idg', 'Kinase'), ('MGI:2449492', 'idg', 'Kinase'), ('MGI:2451244', 'idg', 'GPCR'), ('MGI:2652845', 'idg', 'Kinase'), ('MGI:2652846', 'idg', 'Ion Channel'), ('MGI:2652869', 'idg', 'Kinase'), ('MGI:2652875', 'idg', 'Kinase'), ('MGI:2652894', 'idg', 'Kinase'), ('MGI:2653880', 'idg', 'GPCR'), ('MGI:2655562', 'idg', 'GPCR'), ('MGI:2660884', 'idg', 'Kinase'), ('MGI:2663923', 'idg', 'Ion Channel'), ('MGI:2664099', 'idg', 'Ion Channel'), ('MGI:2664668', 'idg', 'Ion Channel'), ('MGI:2664670', 'idg', 'Ion Channel'), ('MGI:2664902', 'idg', 'Kinase'), ('MGI:2668437', 'idg', 'GPCR'), ('MGI:2669033', 'idg', 'Ion Channel'), ('MGI:2669035', 'idg', 'Ion Channel'), ('MGI:2672983', 'idg', 'GPCR'), ('MGI:2676315', 'idg', 'GPCR'), ('MGI:2677633', 'idg', 'GPCR'), ('MGI:2679274', 'idg', 'Kinase'), ('MGI:2679420', 'idg', 'Kinase'), ('MGI:2681210', 'idg', 'GPCR'), ('MGI:2681218', 'idg', 'GPCR'), ('MGI:2681247', 'idg', 'GPCR'), ('MGI:2681253', 'idg', 'GPCR'), ('MGI:2681256', 'idg', 'GPCR'), ('MGI:2681256', 'idg', 'GPCR'), ('MGI:2681256', 'idg', 'GPCR'), ('MGI:2681256', 'idg', 'GPCR'), ('MGI:2681256', 'idg', 'GPCR'), ('MGI:2681259', 'idg', 'GPCR'), ('MGI:2681273', 'idg', 'GPCR'), ('MGI:2681278', 'idg', 'GPCR'), ('MGI:2681280', 'idg', 'GPCR'), ('MGI:2681298', 'idg', 'GPCR'), ('MGI:2681302', 'idg', 'GPCR'), ('MGI:2681304', 'idg', 'GPCR'), ('MGI:2681304', 'idg', 'GPCR'), ('MGI:2681308', 'idg', 'GPCR'), ('MGI:2681312', 'idg', 'GPCR'), ('MGI:2681862', 'idg', 'Kinase'), ('MGI:2683541', 'idg', 'Kinase'), ('MGI:2684043', 'idg', 'Ion Channel'), ('MGI:2684139', 'idg', 'Ion Channel'), ('MGI:2685008', 'idg', 'Kinase'), ('MGI:2685045', 'idg', 'Kinase'), ('MGI:2685054', 'idg', 'GPCR'), ('MGI:2685064', 'idg', 'GPCR'), ('MGI:2685071', 'idg', 'GPCR'), ('MGI:2685076', 'idg', 'GPCR'), ('MGI:2685128', 'idg', 'Kinase'), ('MGI:2685145', 'idg', 'GPCR'), ('MGI:2685197', 'idg', 'Ion Channel'), ('MGI:2685211', 'idg', 'GPCR'), ('MGI:2685213', 'idg', 'GPCR'), ('MGI:2685222', 'idg', 'GPCR'), ('MGI:2685341', 'idg', 'GPCR'), ('MGI:2685489', 'idg', 'Ion Channel'), ('MGI:2685519', 'idg', 'GPCR'), ('MGI:2685557', 'idg', 'Kinase'), ('MGI:2685845', 'idg', 'GPCR'), ('MGI:2685887', 'idg', 'GPCR'), ('MGI:2685924', 'idg', 'Kinase'), ('MGI:2685925', 'idg', 'Kinase'), ('MGI:2685946', 'idg', 'Kinase'), ('MGI:2685955', 'idg', 'GPCR'), ('MGI:2686146', 'idg', 'GPCR'), ('MGI:3027899', 'idg', 'Kinase'), ('MGI:3033115', 'idg', 'GPCR'), ('MGI:3033139', 'idg', 'GPCR'), ('MGI:3033145', 'idg', 'GPCR'), ('MGI:3033148', 'idg', 'GPCR'), ('MGI:3036247', 'idg', 'Kinase'), ('MGI:3036273', 'idg', 'Ion Channel'), ('MGI:3039580', 'idg', 'Kinase'), ('MGI:3039582', 'idg', 'Kinase'), ('MGI:3041203', 'idg', 'GPCR'), ('MGI:3525078', 'idg', 'GPCR'), ('MGI:3527427', 'idg', 'GPCR'), ('MGI:3527454', 'idg', 'GPCR'), ('MGI:3528383', 'idg', 'Kinase'), ('MGI:3583944', 'idg', 'Kinase'), ('MGI:3584514', 'idg', 'GPCR'), ('MGI:3587025', 'idg', 'Kinase'), ('MGI:3606604', 'idg', 'GPCR'), ('MGI:3609260', 'idg', 'Ion Channel'), ('MGI:3612244', 'idg', 'Ion Channel'), ('MGI:3643278', 'idg', 'GPCR'), ('MGI:3649726', 'idg', 'GPCR'), ('MGI:3694646', 'idg', 'Ion Channel'), ('MGI:87886', 'idg', 'Ion Channel'), ('MGI:87890', 'idg', 'Ion Channel'), ('MGI:87893', 'idg', 'Ion Channel'), ('MGI:88353', 'idg', 'Kinase'), ('MGI:88353', 'idg', 'Kinase'), ('MGI:88543', 'idg', 'Kinase'), ('MGI:88547', 'idg', 'Kinase'), ('MGI:891989', 'idg', 'GPCR'), ('MGI:892973', 'idg', 'GPCR'), ('MGI:894279', 'idg', 'Kinase'), ('MGI:894316', 'idg', 'Kinase'), ('MGI:894318', 'idg', 'Kinase'), ('MGI:894644', 'idg', 'Ion Channel'), ('MGI:894676', 'idg', 'Kinase'), ('MGI:95617', 'idg', 'Ion Channel'), ('MGI:95625', 'idg', 'Ion Channel'), ('MGI:95712', 'idg', 'GPCR'), ('MGI:95749', 'idg', 'Ion Channel'), ('MGI:95750', 'idg', 'Ion Channel'), ('MGI:95751', 'idg', 'Ion Channel'), ('MGI:95812', 'idg', 'Ion Channel'), ('MGI:95816', 'idg', 'Ion Channel'), ('MGI:96283', 'idg', 'GPCR'), ('MGI:96663', 'idg', 'Ion Channel'), ('MGI:96664', 'idg', 'Ion Channel'), ('MGI:96670', 'idg', 'Ion Channel'), ('MGI:96671', 'idg', 'Ion Channel'), ('MGI:96840', 'idg', 'Kinase'), ('MGI:96918', 'idg', 'GPCR'), ('MGI:97303', 'idg', 'Kinase'), ('MGI:97516', 'idg', 'Kinase'), ('MGI:97517', 'idg', 'Kinase'), ('MGI:97518', 'idg', 'Kinase'), ('MGI:97579', 'idg', 'Kinase'), ('MGI:97592', 'idg', 'Kinase'), ('MGI:97594', 'idg', 'Kinase'), ('MGI:97601', 'idg', 'Kinase');
