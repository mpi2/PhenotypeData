...
('C3H.Cg-Ankrd11<Yod>/H',NULL,'MGI:1924337',(SELECT @MGI_DB_ID),'Ankrd11<Yod>','C3H/HeH',(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell'),(SELECT @EUMODIC_PROJECT_ID),(SELECT id FROM organisation WHERE name = 'MRC Harwell')),
