...
VALUES
	('EPD0038_2_B10_10026',NULL,'MGI:98970',(SELECT @DB_ID_MGI),'Xbp1<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(@ORG_ID_ICS),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_ICS),(SELECT @PROJECT_ID_EUMODIC)),
	('DNase-X',NULL,'MGI:109628',(SELECT @DB_ID_MGI),'Dnase1l1<tm1Dkfz>','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('CMHD-TM_N00324P0_T20D4',NULL,'MGI:2158736',(SELECT @DB_ID_MGI),'Senp3<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('Wrnip1tm1a KO',NULL,'MGI:1926153',(SELECT @DB_ID_MGI),'Wrnip1<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Vwde',NULL,'MGI:2685313',(SELECT @DB_ID_MGI),'Vwde<tm1Icmb>','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EUC0050E03',NULL,'MGI:87880',(SELECT @DB_ID_MGI),'Aco2<Gt(EUC0050e03)Hmgu>','129P2/OlaHsd',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0038_2_B10_10557',NULL,'MGI:98970',(SELECT @DB_ID_MGI),'Xbp1<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Tmc1Tmc1<dn>',NULL,'MGI:2151016',(SELECT @DB_ID_MGI),'Tmc1<dn>','STOCK Tmc1<dn>',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0002_2_B07',NULL,'MGI:2150037',(SELECT @DB_ID_MGI),'Mta1<tm1a(EUCOMM)Wtsi>','129/SvEv',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Magi2Magi2<tm1Grnt>',NULL,'MGI:1354953',(SELECT @DB_ID_MGI),'Magi2<tm1Grnt>','129S5;129P2',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('#4',NULL,'MGI:104735',(SELECT @DB_ID_MGI),'Gt(ROSA)26Sor<tm1(FLP1)Dym>','C57BL/6N',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Prkab1Prkab1<Gt(RRR454)Byg>',NULL,'MGI:1336167',(SELECT @DB_ID_MGI),'Prkab1<Gt(RRR454)Byg>','CBA/Ca;129P2',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Arl4',NULL,'MGI:99437',(SELECT @DB_ID_MGI),'Arl4a<tm1Asch>','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EUC0027G03',NULL,'MGI:2142567',(SELECT @DB_ID_MGI),'Arhgef18<Gt(EUC0027g03)Hmgu>','129P2/OlaHsd',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Nox4',NULL,'MGI:1354184',(SELECT @DB_ID_MGI),'Nox4<tm1.1Hwsc>','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Asxl tm1a KO',NULL,'MGI:2684063',(SELECT @DB_ID_MGI),'Asxl1<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Matn1Matn1<tm1Goe>',NULL,'MGI:106591',(SELECT @DB_ID_MGI),'Matn1<tm1Goe>','C57BL/6JTyr;C57BL/6;129S5',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0059_3_A06',NULL,'MGI:1914084',(SELECT @DB_ID_MGI),'Acot13<tm1a(EUCOMM)Wtsi>','C57BL/6NTacDen',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('B6.Cg-Sfrp2<I153N>/H',NULL,'MGI:108078',(SELECT @DB_ID_MGI),'Sfrp2<I153N>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Elk4Elk4<tm1a(EUCOMM)Wtsi/H>',NULL,'MGI:102853',(SELECT @DB_ID_MGI),'Elk4<tm1a(EUCOMM)Wtsi>','C57BL/6',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Ren1Ren1<Ren-1c Enhancer KO>',NULL,'MGI:97898',(SELECT @DB_ID_MGI),'Ren1<Ren-1c Enhancer KO>','C57BL/6JIco',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('CMHD-TM_N00020P0_T5C11',NULL,'MGI:2652885',(SELECT @DB_ID_MGI),'Tbc1d2<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('EUCE0233_A03',NULL,'MGI:102790',(SELECT @DB_ID_MGI),'Rab18<Gt(EUCE0233a03)Hmgu>','129P2/OlaHsd',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('HEPD0634_1_D03',NULL,'MGI:97005',(SELECT @DB_ID_MGI),'Mmp12<tm1a(EUCOMM)Hmgu>','C57BL/6NTac',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('C3H.Cg-Fbxo11<Jf>/H',NULL,'MGI:2147134',(SELECT @DB_ID_MGI),'Fbxo11<Jf>','C3H/HeH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('B6Dnk;129P2-HBP1<Gt(EUCJ0053g09)>/H',NULL,'MGI:894659',(SELECT @DB_ID_MGI),'Hbp1<Gt(EUCJ0053g09)>Hmgu','C57BL/6Dnk',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('CMHD-TM_N01174P0_T28D11',NULL,'MGI:1915987',(SELECT @DB_ID_MGI),'Angel1<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('HST012',NULL,'MGI:102674',(SELECT @DB_ID_MGI),'Umod<urehr4>','C3HeB/FeJ',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EUC0054A05',NULL,'MGI:2137706',(SELECT @DB_ID_MGI),'Actn1<Gt(EUC0054a05)Hmgu>','129P2/OlaHsd',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('129-Smo<tm1Amc>/H',NULL,'MGI:108075',(SELECT @DB_ID_MGI),'Smo<tm1Amc>','129S9/SvEvH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Myo7aMyo7a<Hdb>',NULL,'MGI:104510',(SELECT @DB_ID_MGI),'Myo7a<Hdb>','C3HeB/FeJ',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Ankrd13aAnkrd13a<Gt(RRH308)Byg>',NULL,'MGI:1915670',(SELECT @DB_ID_MGI),'Ankrd13a<Gt(RRH308)Byg>','CBA/Ca;129P2',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('C57BL/6J-Ucp1<m1H>/H',NULL,'MGI:98894',(SELECT @DB_ID_MGI),'Ucp1<m1H>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('EUCJ0004_F10',NULL,'MGI:97316',(SELECT @DB_ID_MGI),'Nfya<Gt(EUCJ0004f10)Hmgu>','C57BL/6NTacDen',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('HST009',NULL,'MGI:103150',(SELECT @DB_ID_MGI),'Slc12a1<urehr3>','C3HeB/FeJ',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('CMHD-TM_N00006P0_T6F5',NULL,'MGI:1917274',(SELECT @DB_ID_MGI),'Mcm10<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('DLG3',NULL,'MGI:1353651',(SELECT @DB_ID_MGI),'Gnl3<Gt(W062C05)Wrst>','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0001_3_E04',NULL,'MGI:1349766',(SELECT @DB_ID_MGI),'Brd7<tm3a(EUCOMM)Wtsi>','129/SvEv',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('EUCJ0079D10',NULL,'MGI:1201409',(SELECT @DB_ID_MGI),'Pknox1<Gt(EUCJ0079d10)Hmgu>','C57BL/6NTacDen',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('C3H.Cg-Ankrd11<Yod>/H',NULL,'MGI:1924337',(SELECT @DB_ID_MGI),'Ankrd11<Yod>','C3H/HeH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('HEPD0527_5_A04',NULL,'MGI:2444491',(SELECT @DB_ID_MGI),'Heatr3<tm1a(EUCOMM)Hmgu>','C57BL/6NTac',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Ptdsr',NULL,'MGI:1858910',(SELECT @DB_ID_MGI),'Jmjd6<tm1.1Gbf>','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Rassf1Rassf1<tm1.2Brd>',NULL,'MGI:1928386',(SELECT @DB_ID_MGI),'Rassf1<tm1.2Brd>','C57BL/6JTyr;129S5',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('clone 1',NULL,'MGI:104874',(SELECT @DB_ID_MGI),'Akt2<tm1Wcs>','129/SvEv',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('129/SvEv-Gnas<tm1Jop>/H',NULL,'MGI:95777',(SELECT @DB_ID_MGI),'Gnas<tm1Jop>','129S9/SvEvH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('ALI14',NULL,'MGI:97616',(SELECT @DB_ID_MGI),'Plcg2<Ali14>','C3HeB/FeJ',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Miz1',NULL,'MGI:1096566',(SELECT @DB_ID_MGI),'Pias2<Gt(pT1Betageo)1Ruiz>','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0019_1_D07',NULL,'MGI:2444748',(SELECT @DB_ID_MGI),'Chd7<tm2a(EUCOMM)Wtsi>','129S5;C57BL/6N',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Ube3bUbe3b<Gt(RRJ142)Byg>',NULL,'MGI:1891295',(SELECT @DB_ID_MGI),'Ube3b<Gt(RRJ142)Byg>','CBA/Ca;129P2',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('B6.129P2-Mro<tm1H>/H',NULL,'MGI:2152817',(SELECT @DB_ID_MGI),'Mro<tm1H>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Cidec tm1a KO',NULL,'MGI:95585',(SELECT @DB_ID_MGI),'Cidec<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('CMHD-TM_N00135P0_T22G9',NULL,'MGI:2654703',(SELECT @DB_ID_MGI),'Otud7b<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('C3H.Cg-Ptk7<chz>/H',NULL,'MGI:1918711',(SELECT @DB_ID_MGI),'Ptk7<chz>','C3H/HeH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('CMHD-TM_N00016P0_T5D5',NULL,'MGI:1916960',(SELECT @DB_ID_MGI),'Arap1<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('B6.Cg-Sfrp5<Q27STOP>/H',NULL,'MGI:1860298',(SELECT @DB_ID_MGI),'Sfrp5<Q27STOP>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('ApoeApoe<tm1Unc>',NULL,'MGI:88057',(SELECT @DB_ID_MGI),'Apoe<tm1Unc>','C57BL/6',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('HEPD0527_4_D08',NULL,'MGI:1350921',(SELECT @DB_ID_MGI),'Fkbp9<tm1a(EUCOMM)Hmgu>','C57BL/6NTac',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('B6.129-Ptch1<tm1Mps>/JH',NULL,'MGI:105373',(SELECT @DB_ID_MGI),'Ptch1<tm1Mps>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('129S9/SvEvH-Nespas<tm3Jop>/H',NULL,'MGI:1861674',(SELECT @DB_ID_MGI),'Gnas/Nespas<tm2.1Jop>','129S9/SvEvH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('C.Cg-Bfc/H',NULL,'MGI:88276',(SELECT @DB_ID_MGI),'Ctnnb1<Bfc>','BALB/cAnNCrl',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('C.Cg-Celsr1<Crsh>/H',NULL,'MGI:1100883',(SELECT @DB_ID_MGI),'Celsr1<Crsh>','BALB/cAnNCrl',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('EUC0047A08',NULL,'MGI:1917329',(SELECT @DB_ID_MGI),'Golm1<Gt(EUC0047a08)Hmgu>','129P2/OlaHsd',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0002_3_G03',NULL,'MGI:1278322',(SELECT @DB_ID_MGI),'Epc1<tm1a(EUCOMM)Wtsi>','129/SvEv',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('C3H.A-Vangl2<Lp>/H',NULL,'MGI:2135272',(SELECT @DB_ID_MGI),'Vangl2<Lp>','C3H/HeH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('NCAM1',NULL,'MGI:97281',(SELECT @DB_ID_MGI),'Ncam1<tm1Cgn>','C57BL/6JIco',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Deltagen_407',NULL,'MGI:2449205',(SELECT @DB_ID_MGI),'Nr1d2<tm1Dgen>','B6J.129S2',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('N00007P0_T5B3',NULL,'MGI:88255',(SELECT @DB_ID_MGI),'Anxa6<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('CMHD-TM_N01605P1_T53C4',NULL,'MGI:2685003',(SELECT @DB_ID_MGI),'Zbtb45<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('Grin2aGrin2a<tm1Rsp>',NULL,'MGI:95820',(SELECT @DB_ID_MGI),'Grin2a<tm1Rsp>','C57BL/6JIco;129P2',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('CMHD-TM_N01539P1_T51C7',NULL,'MGI:1922075',(SELECT @DB_ID_MGI),'Senp6<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('Eya3',NULL,'MGI:109339',(SELECT @DB_ID_MGI),'Eya3<Gt(W096D02)Wrst>','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('CMHD-TM_N00086P0_T24C7',NULL,'MGI:1914737',(SELECT @DB_ID_MGI),'Dhx40<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0001_3_G07',NULL,'MGI:98809',(SELECT @DB_ID_MGI),'Tpm1<tm1a(EUCOMM)Wtsi>','129/SvEv',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Aldh2Aldh2<tm1a(EUCOMM)Wtsi/Hmgu>',NULL,'MGI:99600',(SELECT @DB_ID_MGI),'Aldh2<tm1a(EUCOMM)Wtsi>','C57BL/6',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Nr1i2',NULL,'MGI:1337040',(SELECT @DB_ID_MGI),'Nr1i2','B6J.129S2',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Bin1_mut1',NULL,'MGI:108092',(SELECT @DB_ID_MGI),'Bin1_mut1','B6N.B6J.129S2',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Bin1_mut2',NULL,'MGI:108092',(SELECT @DB_ID_MGI),'Bin1_mut2','B6N.129S2.B6J',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Nr1h4',NULL,'MGI:1352464',(SELECT @DB_ID_MGI),'Nr1h4','B6J.129S2',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Nr6a1',NULL,'MGI:1352459',(SELECT @DB_ID_MGI),'Nr6a1','B6J.129S2',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('EUCJ004_F10',NULL,'MGI:97316',(SELECT @DB_ID_MGI),'Nfya','C57BL/6NTac',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Snx5',NULL,'MGI:1916428',(SELECT @DB_ID_MGI),'Snx5','C57BL/6NTac',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('NR1D1',NULL,'MGI:2444210',(SELECT @DB_ID_MGI),'Nr1d1','B6J.129S2',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Stard3',NULL,'MGI:1929618',(SELECT @DB_ID_MGI),'Stard3','B6N.129S2.B6J',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('STARD3NL',NULL,'MGI:1923455',(SELECT @DB_ID_MGI),'STARD3NL','B6N.129S2.B6J',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Emp3',NULL,'MGI:1098729',(SELECT @DB_ID_MGI),'Emp3','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Ncor2',NULL,'MGI:1337080',(SELECT @DB_ID_MGI),'Ncor2','B6J.129S2',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Strap',NULL,'MGI:1329037',(SELECT @DB_ID_MGI),'Strap','B6J.B6N',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Gbx1',NULL,'MGI:95667',(SELECT @DB_ID_MGI),'Gbx1','C57BL/6J',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Tbp2',NULL,'MGI:2684058',(SELECT @DB_ID_MGI),'Tbp2','B6J.129S2.B6N',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('March 7 targeted gene trap Cross 1',NULL,'MGI:1931053',(SELECT @DB_ID_MGI),'March7','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Nr2b3',NULL,'MGI:98216',(SELECT @DB_ID_MGI),'Rxrg','B6J.129S2',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Gpt2',NULL,'MGI:1915391',(SELECT @DB_ID_MGI),'Gpt2','C57BL/6NTac',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Sighted C3H',NULL,'MGI:97525',(SELECT @DB_ID_MGI),'Pde6b','C3H/HeH',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Nr3c2',NULL,'MGI:99459',(SELECT @DB_ID_MGI),'Nr3c2','B6J.129S2',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Net',NULL,'MGI:101762',(SELECT @DB_ID_MGI),'Elk3','B6J.B6N',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Aste1',NULL,'MGI:1913845',(SELECT @DB_ID_MGI),'Aste1','C57BL/6NTac',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Nr0b2',NULL,'MGI:1346344',(SELECT @DB_ID_MGI),'Nr0b2','B6J.129S2',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Ttll12',NULL,'MGI:3039573',(SELECT @DB_ID_MGI),'Ttll12','B6J.B6N',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('PJA1',NULL,'MGI:1101765',(SELECT @DB_ID_MGI),'PJA1','C57BL/6J',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Dnm2',NULL,'MGI:109547',(SELECT @DB_ID_MGI),'Dnm2','Balb/c.129S2',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Insl5',NULL,'MGI:1346085',(SELECT @DB_ID_MGI),'Insl5','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0518_6_B02',NULL,'MGI:95405',(SELECT @DB_ID_MGI),'Ephx1','C57BL/6NTac',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Rere',NULL,'MGI:2683486',(SELECT @DB_ID_MGI),'Rere','B6J.B6N',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('B6129S8-Tc(Hsa21)1TybEmcf/H',NULL,'MGI:3814702',(SELECT @DB_ID_MGI),'Tc(Hsa21)1TybEmcf','Stock',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('B6.Cg-cub/H',NULL,'MGI:1890156',(SELECT @DB_ID_MGI),'Stx8<tm2a(EUCOMM)Wtsi>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Dll1_C3H_113',NULL,'MGI:104659',(SELECT @DB_ID_MGI),'Dll1<tm1Gos>','C3HeB/FeJ',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Dll1_C3H_10333',NULL,'MGI:104659',(SELECT @DB_ID_MGI),'Dll1<tm1Gos>','129SvJ-Iso',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Gsk3a',NULL,'MGI:2152453',(SELECT @DB_ID_MGI),'Gsk3a<not yet available>','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Kcnip4',NULL,'MGI:1933131',(SELECT @DB_ID_MGI),'Kcnip4<not yet available>','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('March 7 KO (Cross 2)',NULL,'MGI:1931053',(SELECT @DB_ID_MGI),'MARCH7<not yet available>','C57BL''C3H.C-Mecom<Jbo>/H ''/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('C.Cg-Ostes/H',NULL,'MGI:3688249',(SELECT @DB_ID_MGI),'Ostes','BALB/cAnNCrl',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Phex',NULL,'MGI:107489',(SELECT @DB_ID_MGI),'Phex<not yet available>','C3HeB/FeJ',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('VMP1',NULL,'MGI:1923159',(SELECT @DB_ID_MGI),'Vmp1<not yet available>','C57BL/6NTacDen',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Ifitm1_1F4',NULL,'MGI:1915963',(SELECT @DB_ID_MGI),'Ifitm1<not yet assigned>','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('RHBDL5-AG2',NULL,'MGI:2442473',(SELECT @DB_ID_MGI),'Rhbdf2<not yet available>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Myo7aMyo7a<sh1-6J>',NULL,'MGI:104510',(SELECT @DB_ID_MGI),'Myo7a<sh1-6J>','AKR/J;C57BLKS/J',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Atp2b2Atp2b2<Obv>',NULL,'MGI:105368',(SELECT @DB_ID_MGI),'Atp2b2<Obv>','C3HeB/FeJ',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Dlg4Dlg4<tm1Grnt>',NULL,'MGI:1277959',(SELECT @DB_ID_MGI),'Dlg4<tm1Grnt>','C57BL/6JIco;129P2',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Ttll4Ttll4<tm1a(EUCOMM)Wtsi/H>',NULL,'MGI:1914784',(SELECT @DB_ID_MGI),'Ttll4<tm1a(EUCOMM)Wtsi>','C57BL/6N',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('WhrnWhrn<wi>',NULL,'MGI:2682003',(SELECT @DB_ID_MGI),'Whrn<wi>','STOCK Whrn<wi>',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Git2Git2<Gt(XG510)Byg>',NULL,'MGI:1347053',(SELECT @DB_ID_MGI),'Git2<Gt(XG510)Byg>','CBA/Ca;129P2',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Secisbp2Secisbp2<tm1a(EUCOMM)Wtsi/H>',NULL,'MGI:1922670',(SELECT @DB_ID_MGI),'Secisbp2<tm1a(EUCOMM)Wtsi>','C57BL/6N',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Chd7Chd7<Whi>',NULL,'MGI:2444748',(SELECT @DB_ID_MGI),'Chd7<Whi>','C3HeB/FeJ',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Clk1Clk1<tm1a(EUCOMM)Wtsi/Ics>',NULL,'MGI:107403',(SELECT @DB_ID_MGI),'Clk1<tm1a(EUCOMM)Wtsi>','C57BL/6N',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Dlg2Dlg2<tm1Dsb>',NULL,'MGI:1344351',(SELECT @DB_ID_MGI),'Dlg2<tm1Dsb>','C57BL/6JIco',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Ifitm3Ifitm3<tm1Masu>',NULL,'MGI:1913391',(SELECT @DB_ID_MGI),'Ifitm3<tm1Masu>','C57BL/6JIco;C57BL/6JTyr;129P2',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Entpd1Entpd1<tm1a(EUCOMM)Wtsi/Hmgu>',NULL,'MGI:102805',(SELECT @DB_ID_MGI),'Entpd1<tm1a(EUCOMM)Wtsi>','C57BL/6',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('NfyaNfya<Gt(EUCJ0004f10)Hmgu>',NULL,'MGI:97316',(SELECT @DB_ID_MGI),'Nfya<Gt(EUCJ0004f10)Hmgu>','C57BL/6',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('129S9/SvEvH-Ablim1<tm1H>/H',NULL,'MGI:1194500',(SELECT @DB_ID_MGI),'Ablim1<tm1H>','129S9/SvEvH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('129P2/OlaHsd-Fbxl3<Gt(CB0226)Wtsi>/H',NULL,'MGI:1354702',(SELECT @DB_ID_MGI),'Fbxl3<Gt(CB0226)Wtsi>','129P2/OlaHsd',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('C3H.C-Mecom<Jbo>/H',NULL,'MGI:95457',(SELECT @DB_ID_MGI),'Mecom<Jbo>','C3H/HeH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('C3H.B6-Tulp3<hhkr>/H',NULL,'MGI:1329045',(SELECT @DB_ID_MGI),'Tulp3<hhkr>','C3H/HeH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('C3H.C-Trpc3<Mwk>/H',NULL,'MGI:109526',(SELECT @DB_ID_MGI),'Trpc3<Mwk>','C3H/HeH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('129P2/OlaHsd-Tpcn1<Gt(XG716)Byg>/H',NULL,'MGI:2182472',(SELECT @DB_ID_MGI),'Tpcn1<Gt(XG716)Byg>','129P2/OlaHsd',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('B6.Cg-Sfrp2<C50F>/H',NULL,'MGI:108078',(SELECT @DB_ID_MGI),'Sfrp2<C50F>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('129P2/OlaHsd-Map3k1<Gt(YTC001)Byg>/H',NULL,'MGI:1346872',(SELECT @DB_ID_MGI),'Map3k1<Gt(YTC001)Byg>','129P2/OlaHsd',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('B6.129-Kcnj16<tm1Sjtu>/H',NULL,'MGI:1314842',(SELECT @DB_ID_MGI),'Kcnj16<tm1Sjtu>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('mPtpg',NULL,'MGI:1921802',(SELECT @DB_ID_MGI),'Nipal3<tm1Pbfd>','129SV',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EPS8',NULL,'MGI:104684',(SELECT @DB_ID_MGI),'Eps8<tm1Ppdf>','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('FoxP2 delta exon7',NULL,'MGI:2148705',(SELECT @DB_ID_MGI),'Foxp2<tm2.1Woen>','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Abcb4',NULL,'MGI:97569',(SELECT @DB_ID_MGI),'Abcb4<tm1Bor>','FVB/NJ',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Fam63aFam63a<tm1a(EUCOMM)Wtsi/Ics>',NULL,'MGI:1922257',(SELECT @DB_ID_MGI),'Fam63a<tm1a(EUCOMM)Wtsi>','C57BL/6',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Eyl',NULL,'MGI:1100498',(SELECT @DB_ID_MGI),'Pitx3<eyl>','C3H/NHG',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('B6.129-Sfrp1<tm1Aksh>',NULL,'MGI:892014',(SELECT @DB_ID_MGI),'Sfrp1<tm1Aksh>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Tp53',NULL,'MGI:1926609',(SELECT @DB_ID_MGI),'Trp53inp1<tm1Acar>','129/Sv_C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('HEPD0546_1_F01',NULL,'MGI:2685397',(SELECT @DB_ID_MGI),'Rc3h1<tm1a(EUCOMM)Hmgu>','C57BL/6NTac',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('IFIT-2',NULL,'MGI:99449',(SELECT @DB_ID_MGI),'Ifit2<tm1.1Ebsb>','C57BL/6N',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('CMHD-TM_N00105P0_T28A8',NULL,'MGI:1202301',(SELECT @DB_ID_MGI),'Itch<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('Tmem45b',NULL,'MGI:2384574',(SELECT @DB_ID_MGI),'Tmem45b<tm1.1Hsue>','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('DKK3',NULL,'MGI:1354952',(SELECT @DB_ID_MGI),'Dkk3<tm1Cni>','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('T181',NULL,'MGI:1924104',(SELECT @DB_ID_MGI),'Gper1<tm1Dgen>','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('1',NULL,'MGI:1336167',(SELECT @DB_ID_MGI),'Prkab1<tm1a(KOMP)Wtsi>','C57BL/6N',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('CMHD-TM_N00005P0_T11G1',NULL,'MGI:1933401',(SELECT @DB_ID_MGI),'Zfp202<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD060_1_B12',NULL,'MGI:104681',(SELECT @DB_ID_MGI),'Hgs<tm1a(EUCOMM)Wtsi>','C57BL/6NTacDen',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('B6.129P2-Vnn1<tm1Pna>/H',NULL,'MGI:108395',(SELECT @DB_ID_MGI),'Vnn1<tm1Pna>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('MARCH9-KO_NOT_OSN',NULL,'MGI:2446144',(SELECT @DB_ID_MGI),'March9<tm1a(EUCOMM)Wtsi>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Myo6Myo6<sv>',NULL,'MGI:104785',(SELECT @DB_ID_MGI),'Myo6<sv>','C57BL/6JIco;C57BL/10',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('129-Nespas<tm1Jop>/H',NULL,'MGI:1861674',(SELECT @DB_ID_MGI),'Nespas<tm1Jop>','129S8/SvEv-Gpi1<c>/NimrH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Vimentin',NULL,'MGI:98932',(SELECT @DB_ID_MGI),'Vim<tm2Cba>','129/SvPas',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('CMHD-TM_N00343P0_T21F5',NULL,'MGI:1916221',(SELECT @DB_ID_MGI),'Tamm41<tm1(NCOM)Cmhd>','C57BL/6N',((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_CMHD)),(SELECT @PROJECT_ID_EUMODIC)),
	('Cin85',NULL,'MGI:1889583',(SELECT @DB_ID_MGI),'Sh3kbp1<tm1Ivdi>','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0028_5_G01',NULL,'MGI:108086',(SELECT @DB_ID_MGI),'Hdac1<tm1a(EUCOMM)Wtsi>','C57BL/6NTacDen',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('DEA3',NULL,'MGI:2151016',(SELECT @DB_ID_MGI),'Tmc1<Bth>','C3HeB/FeJ',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Glut8',NULL,'MGI:1860103',(SELECT @DB_ID_MGI),'Slc2a8<tm1.1Asch>','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('C3H.Cg-Celsr1<Scy>/H',NULL,'MGI:1100883',(SELECT @DB_ID_MGI),'Celsr1<Scy>','C3H/HeH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Usp6nl',NULL,'MGI:2138893',(SELECT @DB_ID_MGI),'Usp6nl<tm1Ppdf>','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Cadm1Cadm1<tm1.2Brd>',NULL,'MGI:1889272',(SELECT @DB_ID_MGI),'Cadm1<tm1.2Brd>','C57BL/6JIco;C57BL/6JTyr;129S5',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Rhbdl4-/-',NULL,'MGI:1924117',(SELECT @DB_ID_MGI),'Rhbdd1<tm1.1Mfm>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Abcb4_Balb/cJ',NULL,'MGI:97569',(SELECT @DB_ID_MGI),'Abcb4<tm1Bor>','BALB/cByJ',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('129P2/OlaHsd-Tpcn2<Gt(YHD437)Byg>/H',NULL,'MGI:2385297',(SELECT @DB_ID_MGI),'Tpcn2<Gt(YHD437)Byg>','129P2/OlaHsd',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0033_3_C09',NULL,'MGI:1336167',(SELECT @DB_ID_MGI),'Prkab1<tm1a(KOMP)Wtsi>','C57BL/6N',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('EUCJ0019C12',NULL,'MGI:104662',(SELECT @DB_ID_MGI),'Pml<Gt(EUCJ0019c12)Hmgu>','C57BL/6NTacDen',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EUC BL6-FP00042B07',NULL,'MGI:1934229',(SELECT @DB_ID_MGI),'Setdb1<tm1a(EUCOMM)Wtsi>','C57BL/6NTacDen',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('NADH',NULL,'MGI:1918611',(SELECT @DB_ID_MGI),'Aifm2<tm1Avm>','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Matn3Matn3<tm1Brd>',NULL,'MGI:1328350',(SELECT @DB_ID_MGI),'Matn3<tm1Brd>','C57BL/6JTyr;C57BL/6;129S5',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Kctd10Kctd10<Gt(RRG305)Byg>',NULL,'MGI:2141207',(SELECT @DB_ID_MGI),'Kctd10<Gt(RRG305)Byg>','CBA/Ca;129P2',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Grxcr1Grxcr1<tde>',NULL,'MGI:3577767',(SELECT @DB_ID_MGI),'Grxcr1<pi-tde>','STOCK Grxcr1<tde>',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('ENSMUSG00000065586ENSMUSG00000065586<Dmdo>',NULL,'MGI:3619440',(SELECT @DB_ID_MGI),'Mir96<Dmdo>','C3HeB/FeJ',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Stx8tm3a KO',NULL,'MGI:1890156',(SELECT @DB_ID_MGI),'Stx8<tm2a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Ino80e tm1a KO',NULL,'MGI:2141881',(SELECT @DB_ID_MGI),'Ino80e<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Dmbt1',NULL,'MGI:106210',(SELECT @DB_ID_MGI),'Dmbt1<tm1Janm>','C57BL/6',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('B6.129-Sfrp2<tm1Aksh>',NULL,'MGI:108078',(SELECT @DB_ID_MGI),'Sfrp2<tm1Aksh>','C57BL/6J',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('M076C04',NULL,'MGI:1915372',(SELECT @DB_ID_MGI),'Nkain4<Gt(M076C04)Vmel>','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('C1orf37',NULL,'MGI:1914729',(SELECT @DB_ID_MGI),'Tg(TMEM183B)1Pbo','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0288_3_A08',NULL,'MGI:2429409',(SELECT @DB_ID_MGI),'Afm<tm1a(KOMP)Wtsi>','C57BL/6NTac',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('Dll1<C413Y>',NULL,'MGI:104659',(SELECT @DB_ID_MGI),'Dll1<m1Mhda>','C3HeB/FeJ',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('FoxP2',NULL,'MGI:2148705',(SELECT @DB_ID_MGI),'Foxp2<tm1Woen>','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('129-Shh<tm1Chg>/H',NULL,'MGI:98297',(SELECT @DB_ID_MGI),'Shh<tm1Chg>','129S9/SvEvH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('HEPD0527_2_D03',NULL,'MGI:2685493',(SELECT @DB_ID_MGI),'Pla2g4f<tm1a(EUCOMM)Hmgu>','C57BL/6NTac',((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_ICS)),(SELECT @PROJECT_ID_EUMODIC)),
	('129S9/SvEvH-Nodal<tm1Rob>/H',NULL,'MGI:97359',(SELECT @DB_ID_MGI),'Nodal<tm1Rob>','129S9/SvEvH',((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_MRC_HARWELL)),(SELECT @PROJECT_ID_EUMODIC)),
	('Hmx3Hmx3<hx>',NULL,'MGI:107160',(SELECT @DB_ID_MGI),'Hmx3<tm1Ebo>','STOCK Hmx3<hx>',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('ABE1',NULL,'MGI:104785',(SELECT @DB_ID_MGI),'Myo6<Tlc>','C3HeB/FeJ',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Tnfaip1Tnfaip1<tm1a(EUCOMM)Wtsi/H>',NULL,'MGI:104961',(SELECT @DB_ID_MGI),'Tnfaip1<tm1a(EUCOMM)Wtsi>','C57BL/6N',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),
	('Hhip',NULL,'MGI:1341847',(SELECT @DB_ID_MGI),'Hhip<tm1Icmb>','C57BL/6J',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('Cdh23Cdh23<v>',NULL,'MGI:1890219',(SELECT @DB_ID_MGI),'Cdh23<v>','STOCK Cdh23<v>',((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC),((SELECT @ORG_ID_WTSI)),(SELECT @PROJECT_ID_EUMODIC)),

	-- line-based hand-curated colonyIds
	('EPD0080_1_B11',NULL,'MGI:2684063',(SELECT @DB_ID_MGI),'Asxl1<tm1a(EUCOMM)Wtsi>', 'C57BL/6NTac',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0059_2_G04',NULL,'MGI:1926153',(SELECT @DB_ID_MGI),'Wrnip1<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0060_1_B12',NULL,'MGI:104681', (SELECT @DB_ID_MGI),'Hgs<tm1a(EUCOMM)Wtsi>',   'C57BL/6NTac',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0177_2_H03',NULL,'MGI:2141881',(SELECT @DB_ID_MGI),'Ino80e<tm1a(EUCOMM)Wtsi>','C57BL/6NTac',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC)),
	('EPD0116_3_D06',NULL,'MGI:95585',  (SELECT @DB_ID_MGI),'Cidec<tm1a(EUCOMM)Wtsi>', 'C57BL/6NTac',(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC),(SELECT @ORG_ID_HMGU),(SELECT @PROJECT_ID_EUMODIC));
