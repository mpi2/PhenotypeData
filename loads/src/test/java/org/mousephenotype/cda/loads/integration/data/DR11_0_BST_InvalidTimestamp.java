 ...
 *
 * This test validates that timestamp data written on the day BST changes by skipping 01:00 to 01_59
 * fails because of an invalid date.
 *
 * Unfortunately, the H2 database doesn't throw an exception, though mysql does. So currently this test does not fail
 * when it is expected to fail.
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ComponentScan
@ContextConfiguration(classes = TestConfig.class)
public class DR11_0_BST_InvalidTimestamp {
    ...
    public void testXmlStrainNotInImits() throws Exception {
        ...
        Resource cdaResource        = context.getResource("classpath:sql/h2/DR11_0_BST_InvalidTimestamp-data.sql");
        Resource specimenResource   = context.getResource("classpath:xml/DR11_0_BST_InvalidTimestamp-specimens.xml");
        Resource experimentResource = context.getResource("classpath:xml/DR11_0_BST_InvalidTimestamp-experiments.xml");
