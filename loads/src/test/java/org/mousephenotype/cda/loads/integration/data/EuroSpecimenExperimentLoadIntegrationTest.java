...
public class EuroSpecimenExperimentLoadIntegrationTest {
    ...
    public void testLoadMissingSpecimenAndExperiment() throws Exception {
        ...
        Resource cdaResource        = context.getResource("classpath:sql/h2/LoadEuroSpecimenExperiment-data.sql");
        Resource specimenResource   = context.getResource("classpath:xml/EuroSpecimenExperiment-specimens.xml");
        Resource experimentResource = context.getResource("classpath:xml/EuroSpecimenExperiment-experiments.xml");
