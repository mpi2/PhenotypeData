 ...
 *
 * This test validates DR11.0 3i data that wasn't loading is now loading.
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ComponentScan
@ContextConfiguration(classes = TestConfig.class)
public class DR11_0_UnknownSpecimen_3i {
    ...
    @Test
    public void test3iIsLoading() throws Exception {

        Resource cdaResource        = context.getResource("classpath:sql/h2/DR11_0_UnknownSpecimen_3i-data.sql");
        Resource specimenResource   = context.getResource("classpath:xml/DR11_0_UnknownSpecimen_3i-specimens.xml");
        Resource experimentResource = context.getResource("classpath:xml/DR11_0_UnknownSpecimen_3i-experiments.xml");
        ...
        Assert.assertEquals("NonStringNonNumericValue", cdaSqlUtils.getExperimentBackgroundStrain("3i_617908").getName());
    }
}