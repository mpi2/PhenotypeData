...
public class EuroSpecimenExperimentLoadIntegrationTest2 {
    ...
    public void testLoadMissingSpecimenAndExperiment() throws Exception {
        ...
        Resource cdaResource        = context.getResource("classpath:sql/h2/LoadEuroSpecimenExperiment-data2.sql");
        Resource specimenResource   = context.getResource("classpath:xml/EuroSpecimenExperiment-specimens2.xml");
        Resource experimentResource = context.getResource("classpath:xml/EuroSpecimenExperiment-experiments2.xml");
