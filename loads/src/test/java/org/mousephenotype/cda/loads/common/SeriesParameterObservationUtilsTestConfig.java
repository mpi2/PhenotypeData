 ...
 */
@Configuration
public class SeriesParameterObservationUtilsTestConfig {
	...
	@Bean(name = "seriesParameterObservationUtilsDataSourceH2")
	@Primary
	public DataSource seriesParameterDataSourceH2() {
		return new EmbeddedDatabaseBuilder().setType(EmbeddedDatabaseType.H2)
                                            .ignoreFailedDrops(true)
                                            .setName("series_parameter_test")
                                            .build();
	}

	@Bean
	public NamedParameterJdbcTemplate jdbcCdaBase() {
		return new NamedParameterJdbcTemplate(seriesParameterDataSourceH2());
	}
...
//		em.setDataSource(seriesParameterDataSourceH2());
...
//		hibernateProperties.put("hibernate.hbm2ddl.import_files", "sql/SeriesParameterObservationUtilsTest.sql");
