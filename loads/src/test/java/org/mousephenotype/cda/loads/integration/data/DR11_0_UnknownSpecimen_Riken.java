 ...
 *
 * This test validates DR11.0 RIKEN data that wasn't loading is now loading.
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ComponentScan
@ContextConfiguration(classes = TestConfig.class)
public class DR11_0_UnknownSpecimen_Riken {
    ...
    @Test
    public void testRIKENIsLoading() throws Exception {

        Resource cdaResource        = context.getResource("classpath:sql/h2/DR11_0_UnknownSpecimen_Riken-data.sql");
        Resource specimenResource   = context.getResource("classpath:xml/DR11_0_UnknownSpecimen_Riken-specimens.xml");
        Resource experimentResource = context.getResource("classpath:xml/DR11_0_UnknownSpecimen_Riken-experiments.xml");
...
//        Assert.assertEquals("strain_5", cdaSqlUtils.getExperimentBackgroundStrain("IMPC_BWT_001_2016-10-07").getName());
    }
}