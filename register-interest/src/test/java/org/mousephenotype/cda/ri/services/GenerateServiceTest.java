...
public class GenerateServiceTest extends BaseTest {
    ...
    public void getSummaryContentWithGenes() {
        ...
        inHtml = false;
        content = generateService.getSummaryContent(org.mousephenotype.cda.ri.services.BaseTestConfig.PA_BASE_URL, summaryWithDecoration, inHtml);
    ...
    public void getSummaryContentNoGenes() {
        ...
        summary = generateService.getsummaryByEmailAddress(user3);
        inHtml = false;
        content = generateService.getSummaryContent(org.mousephenotype.cda.ri.services.BaseTestConfig.PA_BASE_URL, summary, inHtml);
    ...
    private static String expectedSummaryContentInHtml        =
            "Dear colleague,\n" +
                    ...
                    "<br /><br /><style>  table {    font-family: arial, sans-serif;    border-collapse: collapse;    width: 100%;}td, th {    border: 1px solid #dddddd;    text-align: left;    padding: 8px;}tr:nth-child(even) {    background-color: #dddddd;}</style><table id=\"genesTable\"><tr><th>Gene Symbol</th><th>Gene MGI Accession Id</th><th>Assignment Status</th><th>Null Allele Production</th><th>Conditional Allele Production</th><th>Phenotyping Data Available</th></tr><tr><td><a href=\"https://dev.mousephenotype.org/data/genes/MGI:103576\" alt=\"https://dev.mousephenotype.org/data/genes/MGI:103576\">Ccl11</a></td><td><a href=\"http://www.informatics.jax.org/marker/MGI:103576\" alt=\"http://www.informatics.jax.org/marker/MGI:103576\">MGI:103576</a></td><td>Withdrawn *</td><td>None</td><td>None *</td><td>No</td><tr><td><a href=\"https://dev.mousephenotype.org/data/genes/MGI:1919199\" alt=\"https://dev.mousephenotype.org/data/genes/MGI:1919199\">Cers5</a></td><td><a href=\"http://www.informatics.jax.org/marker/MGI:1919199\" alt=\"http://www.informatics.jax.org/marker/MGI:1919199\">MGI:1919199</a></td><td>Selected for production and phenotyping</td><td><a href=\"https://dev.mousephenotype.org/data/genes/MGI:1919199/#order\" alt=\"https://dev.mousephenotype.org/data/genes/MGI:1919199/#order\">Genotype confirmed mice</a></td><td><a href=\"https://dev.mousephenotype.org/data/genes/MGI:1919199/#order\" alt=\"https://dev.mousephenotype.org/data/genes/MGI:1919199/#order\">Genotype confirmed mice</a></td><td><a href=\"https://dev.mousephenotype.org/data/genes/MGI:1919199/#order\" alt=\"https://dev.mousephenotype.org/data/genes/MGI:1919199/#order\">Yes</a></td><tr><td><a href=\"https://dev.mousephenotype.org/data/genes/MGI:2443658\" alt=\"https://dev.mousephenotype.org/data/genes/MGI:2443658\">Prr14l</a></td><td><a href=\"http://www.informatics.jax.org/marker/MGI:2443658\" alt=\"http://www.informatics.jax.org/marker/MGI:2443658\">MGI:2443658</a></td><td>Selected for production and phenotyping</td><td><a href=\"https://dev.mousephenotype.org/data/genes/MGI:2443658/#order\" alt=\"https://dev.mousephenotype.org/data/genes/MGI:2443658/#order\">Genotype confirmed mice *</a></td><td>None</td><td>No *</td></table><br />* Gene assignment status has changed since the last e-mail sent to you.<br /><br />You may review our e-mail list privacy policy at:<br /><br /><div><a href=\"https://www.ebi.ac.uk/data-protection/privacy-notice/impc-mailservices\" alt=\"https://www.ebi.ac.uk/data-protection/privacy-notice/impc-mailservices\">https://www.ebi.ac.uk/data-protection/privacy-notice/impc-mailservices</a></div><br />For further information / enquiries please write to <a href=\"mailto: mouse-helpdesk@ebi.ac.uk\">mouse-helpdesk@ebi.ac.uk</a>.<br /><br />Best Regards,\n" +
                    "<br /><br />The IMPC team";
