...
public class GenerateServiceTest extends BaseTest {
    ...
    private static String expectedSummaryContentNoHtml =
            "Dear colleague,\n" +
                    ...
                    "\n" +
                    "\n" +
                    "You may manage the list of genes for which you have registered interest by visiting the IMPC 'summary' page at https://www.ebi.ac.uk/mi/impc/phenotype-archive/summary.\n" +
                    "\n" +
                    "\n" +
