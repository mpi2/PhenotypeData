 ...
 */
@Component
public class PhenotypeHitsPerParameter extends AbstractReport {
    ...
    public PhenotypeHitsPerParameter() {
        super();
    }
    ...
    public void run(String[] args) throws ReportException {
        ...
        if ( ! errors.isEmpty()) {
            logger.error("HitsPerParameterReport parser validation error: " + StringUtils.join(errors, "\n"));
            return;
        }
        initialise(args);
