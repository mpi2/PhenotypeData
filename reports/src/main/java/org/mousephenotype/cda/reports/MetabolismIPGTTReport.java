...
public class MetabolismIPGTTReport extends AbstractReport {
    ...
    public void run(String[] args) throws ReportException {
        ...
        if ( ! errors.isEmpty()) {
            logger.error("MetabolismIPGTTReport parser validation error: " + StringUtils.join(errors, "\n"));
            return;
        }
        initialise(args);
            ...
            switch (parameterStableId) {
                ...
                case "IMPC_IPG_002_001":
                    ...
                    switch (discretePoint) {
                        case 0:
                            if (data[0] != null) {
                                localWarn.add("Expected only 1 IMPC_IPG_002_001 dataPoint for discretePoint 0 for biological_sample_id '" + biologicalSampleId + "' (" + externalSampleId + ") but found more.");
                            }
                            data[0] = dataPoint;
                            break;
                        ...
                        case 15:
                            if (data[1] != null) {
                                localWarn.add("Expected only 1 IMPC_IPG_002_001 dataPoint for discretePoint 15 for biological_sample_id '" + biologicalSampleId + "' (" + externalSampleId + ") but found more.");
                            }
                            data[1] = dataPoint;
                            break;
                        ...
                        case 30:
                            if (data[2] != null) {
                                localWarn.add("Expected only 1 IMPC_IPG_002_001 dataPoint for discretePoint 30 for biological_sample_id '" + biologicalSampleId + "' (" + externalSampleId + ") but found more.");
                            }
                            data[2] = dataPoint;
                            break;
                        ...
                        case 60:
                            if (data[3] != null) {
                                localWarn.add("Expected only 1 IMPC_IPG_002_001 dataPoint for discretePoint 60 for biological_sample_id '" + biologicalSampleId + "' (" + externalSampleId + ") but found more.");
                            }
                            data[3] = dataPoint;
                            break;
                        ...
                        case 120:
                            if (data[4] != null) {
                                localWarn.add("Expected only 1 IMPC_IPG_002_001 dataPoint for discretePoint 120 for biological_sample_id '" + biologicalSampleId + "' (" + externalSampleId + ") but found more.");
                            }
                            data[4] = dataPoint;
                            break;

                        default:
                            localWarn.add("Unexpected discretePoint '" + dataPoint + "' for biological_sample_id '" + biologicalSampleId + "' (" + externalSampleId + ") but found more.");
                    }
                ...
                case "IMPC_IPG_010_001":
                    if (data[0] != null) {
                        warnings[2] = "Expected only 1 IMPC_IPG_010_001 dataPoint for biological_sample_id '" + biologicalSampleId + "' (" + externalSampleId + ") but found more.";
                        hasWarnings[2] = true;
                    }
