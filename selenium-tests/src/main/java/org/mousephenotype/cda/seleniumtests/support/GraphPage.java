...
public class GraphPage {
    ...
    private void load() throws TestException {
        ...
        if ( ! postQcTableElementList.isEmpty()) {
            ...
            graphElements.addAll(wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(postQcXpathTable))));
        }
        if ( ! postQcGraphElementList.isEmpty()) {
            System.out.println("WAITING FOR postQcGraph");
            graphElements.addAll(wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(postQcXpathChart))));
        }
        if ( ! preQcOkElementList.isEmpty()) {
            System.out.println("WAITING FOR preQcOk");
            graphElements.addAll(wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.xpath(preqcXpathOk))));
        }
...
//        }
        ...
        for (WebElement chartElement : graphElements) {
