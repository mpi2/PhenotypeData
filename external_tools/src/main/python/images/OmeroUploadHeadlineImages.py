"""
    Modification of OmeroUpload to do one-off uploading of headline images.

    Instead of querying solr, this script reads a text file mocking the results
    of a solr query that is used in OmeroUpload. For each
...
def main(argv):
    ...
    parser.add_argument('-i', '--inFilePath', dest='inFilePath', required=True,
    ...
    # Get mock results of solr query
    with open(args.inFilePath, 'rt') as fid:
