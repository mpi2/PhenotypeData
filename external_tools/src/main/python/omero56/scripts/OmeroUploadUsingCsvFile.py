...
## Comment out parts to do with OmeroPropertyParser
...
##            return
##    try:
##        root_dir = args.rootDestinationDir if args.rootDestinationDir is not None else omeroProps['rootdestinationdir']
##        omeroHost = args.omeroHost if args.omeroHost is not None else omeroProps['omerohost']
##    except Exception as e:
...
## Assign omero properties manually
    ...
    ## TODO: Check the OmeroService method for annotations does not lead
    ##       to annotations being duplicated!!!
    omero_annotation_list = omeroS.getAnnotationsAlreadyInOmero()
