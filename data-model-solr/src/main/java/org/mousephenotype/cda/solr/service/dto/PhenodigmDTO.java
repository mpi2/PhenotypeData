...
public class PhenodigmDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (diseaseTerm != null ? !diseaseTerm.equals(that.diseaseTerm) : that.diseaseTerm != null) {
            return false;
        }
        if (diseaseAlts != null ? !diseaseAlts.equals(that.diseaseAlts) : that.diseaseAlts != null) {
            return false;
        }
        if (diseaseLocus != null ? !diseaseLocus.equals(that.diseaseLocus) : that.diseaseLocus != null) {
            return false;
        }
        ...
        if (hgncGeneID != null ? !hgncGeneID.equals(that.hgncGeneID) : that.hgncGeneID != null) {
            return false;
        }
        ...
        if (alleleIds != null ? !alleleIds.equals(that.alleleIds) : that.alleleIds != null) {
            return false;
        }
        if (homHet != null ? !homHet.equals(that.homHet) : that.homHet != null) {
            return false;
        }
        if (humanCurated != null ? !humanCurated.equals(that.humanCurated) : that.humanCurated != null) {
            return false;
        }
        if (mouseCurated != null ? !mouseCurated.equals(that.mouseCurated) : that.mouseCurated != null) {
            return false;
        }
        if (mgiPredicted != null ? !mgiPredicted.equals(that.mgiPredicted) : that.mgiPredicted != null) {
            return false;
        }
        ...
        if (modModel != null ? !modModel.equals(that.modModel) : that.modModel != null) {
            return false;
        }
        if (htpcModel != null ? !htpcModel.equals(that.htpcModel) : that.htpcModel != null) {
            return false;
        }
        ...
        if (rawModScore != null ? !rawModScore.equals(that.rawModScore) : that.rawModScore != null) {
            return false;
        }
        if (rawHtpcScore != null ? !rawHtpcScore.equals(that.rawHtpcScore) : that.rawHtpcScore != null) {
            return false;
        }
        if (inLocus != null ? !inLocus.equals(that.inLocus) : that.inLocus != null) {
            return false;
        }
        if (litModel != null ? !litModel.equals(that.litModel) : that.litModel != null) {
            return false;
        }
        ...
        if (rawScore != null ? !rawScore.equals(that.rawScore) : that.rawScore != null) {
            return false;
        }
        if (hpMatchedTerms != null ? !hpMatchedTerms.equals(that.hpMatchedTerms) : that.hpMatchedTerms != null) {
            return false;
        }
        if (mpMatchedIds != null ? !mpMatchedIds.equals(that.mpMatchedIds) : that.mpMatchedIds != null) {
            return false;
        }
        ...
        if (mpID != null ? !mpID.equals(that.mpID) : that.mpID != null) {
            return false;
        }
        if (mpTerm != null ? !mpTerm.equals(that.mpTerm) : that.mpTerm != null) {
            return false;
        }
        if (hpID != null ? !hpID.equals(that.hpID) : that.hpID != null) {
            return false;
        }
        if (hpTerm != null ? !hpTerm.equals(that.hpTerm) : that.hpTerm != null) {
            return false;
        }
        if (hpSynonym != null ? !hpSynonym.equals(that.hpSynonym) : that.hpSynonym != null) {
            return false;
        }
        if (phenotypes != null ? !phenotypes.equals(that.phenotypes) : that.phenotypes != null) {
            return false;
        }
