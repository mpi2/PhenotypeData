...
public class EmbryoViewerService {
    ...
    private Map<String, String> populateUmassData(){
        List<String> originalUmassGeneSymbols = Arrays.asList("4933427D14Rik", "Aasdhppt", "Aatf", "Actr8", "Alg14", "Ap2s1", "Atp2b1", "Atp5d", "Atp6v1f", "B4gat1", "Bc052040", "Bcs1l", "Borcs6", "Casc3", "Ccdc59", "Cct7", "Cct8", "Cdc37", "Cenpo", "Cherp", "Clptm1", "Clpx", "Cog1", "Dbr1", "Dctn6", "Ddx21", "Ddx46", "Ddx47", "Ddx59", "Dhx37", "Dhx8", "Dnaaf2", "Dnajc13", "Dolk", "Early Gene Expression", "Ebna1bp2", "Efl1", "Eif2s1", "Eif5b", "Eipr1", "Elof1", "Eny2", "Exoc2", "Exosc2", "Fastkd5", "Gemin6", "Glrx3", "Gspt1", "Gtpbp4", "Haus4", "Hlcs", "Ipo11", "Ipo7", "Isca1", "Lin52", "Ltv1", "Mars2", "Mbip", "Mcrs1", "Med20", "Mepce", "Mrm3", "Mrpl22", "Mrpl3", "Mrpl41", "Mrpl44", "Mrps18c", "Mrps22", "Mrps25", "Mtpap", "Nars", "Nars2", "Ncapd3", "Ndc80", "Ndufa9", "Ndufs8", "Nifk", "Nsl1", "Nup155", "Nup205", "Nup93", "Orc2", "Orc6", "Osbp", "Pdcd7", "Phenotypes of Novel IMPC Alleles", "Pmpcb", "Pold2", "Polr1a", "Polr1d", "Polr2b", "Pop5", "Ppp1r35", "Prim1", "Prpf4b", "Rab11a", "Rad54l2", "Ranbp2", "Rbbp4", "Riok1", "Rpain", "Sars", "Sart3", "Scfd1", "Sdhaf2", "Sepsecs", "Ska2", "Smarce1", "Snapc2", "Snrnp70", "Sptb", "Sptssa", "Strn3", "Taf1c", "Taf1d", "Tbcb", "Tbcc", "Tbcd", "Thoc3", "Thoc7", "Timm22", "Tmx2", "Tomm20", "Tpk1", "Trit1", "Trmt5", "Tsen54", "Ttc1", "Ttk", "Tubgcp2", "Tubgcp4", "U2af2", "Ube2m", "Uqcr10", "Washc4", "Wdr73", "Ykt6", "Ylpm1", "Zc3h4", "Zfp407", "Zfp622", "Zwint");
