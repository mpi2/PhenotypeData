...
@Service
public class ProcedureCompletenessAllService extends BasicService {
	...
	@Inject
	public ProcedureCompletenessAllService(
    ...
    public final Set<String> missingMpTermNames = new HashSet<>();
    ...
    public List<String> buildOutputRow(String center, Set<PhenotypeCenterAllServiceBean> dataByCenter,
                                       ProcedureCompletenessDTO dto) {

        Map<String, String> procedureNamesById = phenotypeCenterAllService.getProcedureNamesById();
        Map<String, String> parameterNamesById = phenotypeCenterAllService.getParameterNamesById();
        Map<String, String> mpNamesById = phenotypeCenterAllService.getMpNamesById();


        // Filter data by lifeStageName, zygosity, and colonyId.
        List<PhenotypeCenterAllServiceBean> rowData = dataByCenter
            .stream()
            .filter(b -> dto.getLifeStageName().equalsIgnoreCase(b.getLifeStageName()))
            .filter(b -> dto.getZygosity().equalsIgnoreCase(b.getZygosity()))
            .filter(b -> dto.getColonyId().equalsIgnoreCase(b.getColonyId()))
        ...
        final List<String> mpNamesSuccess = mpIdsSuccess
                ...
                .map(mpId -> {
                    ...
                    if (mpName == null) {
                        missingMpTermNames.add(center + "::" + mpId);
        ...
        try {
            ...
            row.add(rowData.get(0).getStrainName());
            row.add(rowData.get(0).getStrainAccessionId());
	...
	public class ProcedureCompletenessDTO {
        ...
        public String toString() {
            return "ProcedureCompletenessDTO{" +
    ...
    public Set<PhenotypeCenterAllServiceBean> getCenterData(String center) {
