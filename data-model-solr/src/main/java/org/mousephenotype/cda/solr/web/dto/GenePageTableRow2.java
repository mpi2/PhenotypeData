 ...
 */
public class GenePageTableRow2 extends DataTableRow {

    public GenePageTableRow2() {
        super();
    }

    public GenePageTableRow2(PhenotypeCallSummary pcs, String baseUrl, Map<String, String> config) {
