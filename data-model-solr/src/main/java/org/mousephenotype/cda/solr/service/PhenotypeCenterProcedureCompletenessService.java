...
public class PhenotypeCenterProcedureCompletenessService {
	...
	// FIXME FIXME FIXME
    // NEW STUFF FOR ProcedureCompletenessAllReport
    // FIXME FIXME FIXME
	 ...
	 * @throws SolrServerException, IOException
	 */
	public List<String[]> getCentersProgressByStrainCsv2() throws SolrServerException, IOException, URISyntaxException {
