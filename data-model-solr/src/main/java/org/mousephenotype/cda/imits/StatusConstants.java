 ...
 * License.
 *******************************************************************************/
package org.mousephenotype.cda.imits;
...
public class StatusConstants {
	...
	public static final String IMITS_MOUSE_PHENOTYPING_ATTEMPT_REGISTERED = "Phenotype Attempt Registered";
	public static final String IMITS_MOUSE_PHENOTYPING_STARTED = "Phenotyping Started";
	public static final String IMITS_MOUSE_PHENOTYPING_COMPLETE = "Phenotyping Complete";
	
	public static final String WEB_MOUSE_PHENOTYPING_DATA_AVAILABLE = "phenotype data available";
	public static final String WEB_MOUSE_PHENOTYPING_LEGACY_DATA_AVAILABLE = "legacy data available";
