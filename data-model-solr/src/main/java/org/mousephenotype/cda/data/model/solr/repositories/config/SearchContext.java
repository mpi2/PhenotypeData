 ...
 */
package org.mousephenotype.cda.data.model.solr.repositories.config;
 ...
 */
@Configuration
@EnableSolrRepositories(basePackages = { "org.mousephenotype.cda.data.model.solr.repositories.image" }, multicoreSupport=true)
