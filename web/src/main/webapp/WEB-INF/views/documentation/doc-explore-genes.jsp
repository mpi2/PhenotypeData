...
<t:genericpage>
  ...
  <jsp:attribute name="breadcrumb">&nbsp;&raquo;&nbsp;<a href="${baseUrl}/documentation/doc-overview">Documentation</a> &raquo; <a href="${baseUrl}/documentation/doc-explore">explore data</a> &raquo; <a href="${baseUrl}/documentation/doc-explore-genes">explore Genes</a></jsp:attribute>
