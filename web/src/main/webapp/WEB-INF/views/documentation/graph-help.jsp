                ...
                <div class="region region-content">              
                    ...
                    <div class="block block-system">
                        ...
                        <div id="top" class="content node">
                            ...
                            <p>
                                Data for the charts are obtained both from the IMPC phenotyping centers as well as the <a href="http://www.europhenome.org/"> Europhenome</a> legacy project.
                                The table of genotype to phenotype associations on the gene and phenotype pages include links to charts of the data and more information about the processing used to determine statistical significance.</p>
                            ...
                            <p>Charts are interactive so that you can adjust the view to your liking. Click on a legend will remove a set of data from the graph. This is especially useful if you wish to remove "noise" from a chart and focus on the control or experimental data. <img src="img/graph_legends.png"> 
                            </p>

                            <p>After clicking on the control legend the male homozygote data has disappeared:</p>
                            <img src="img/graph_no_control.png" alt="chart with no control here">
                            
                            <p>Hovering over a data point or error bars displays extra information about the data point: </p>
                            <img src="img/graph_hover.png" alt="chart with a hovering over mouse label here">
                            
                            <p>If appropriate the chart will allow you to zoom in on a data set by clicking and dragging to create a square/zoomable area:</p>
                            <img src="img/graph_before_zoom.png" alt="Scatter chart with no zoom shown here">
                            
                            <p>Once zoomed a "Reset zoom" button appears at the right of the chart to enable the chart to be reset to original position:</p>
                            <img src="img/graph_after_zoom.png" alt="Zoomed in chart here">
														
														<p> Parts of the chart header are also interactive. Clicking on the pipeline and procedure links will take nevigate you to the IMPRESS page describing them. </p> 
														<img src="img/graph_header.png"  alt="Chart header"/>
														<br/><br/><br/><br/>												
																

                            <h3><a name="export" href='#'>Exporting Chart Data</a></h3>
                            <p>An export button is always visible on the right hand side of the charts where the chart picture can be exported in png, jpeg, pdf or svg format which will be downloaded to your computer:
                            <img src="img/graph_export.png" alt="export button in chart here">
                            
                            <p>The data used to generate the charts can be downloaded in XLS or TSV formats from the buttons on the top of the page (<img src="img/graph-data-export.png" 
                                                                                                                                                          alt="export button in chart here">). This will export data for all charts shown on the page. Data for males and females from the same experiment will be shown 
                            ...
                            <br/>
                            <p> A <b>restful web service</b> is also available for retrieving information pertaining to experiments via a web browser or a programming language 
                            	of your choice. Documentation for this can be found <a href="https://github.com/mpi2/PhenotypeArchive/wiki">here</a>.			
                            </p>

                            
                            <h3><a name="types" href='#'>Types of Charts and Equations</a></h3>
                            <p>Currently 4 types of chart exist in the IMPC portal from the IMPC:</p>
                            <ol>
                            ...
                            <br/><br/>
                            <p>Where an observation can be measured on a continuous basis (e.g. red blood cell counts or tail length), we display them in a mixed box and scatter plot. 
                            	The first columns contain box plots for Wild Type (control), Homozygote then Heterozygote mutants for female then the columns representing males. 
                            	The second set of columns contain scatter plots for the same sets of data. Hover over the box in the chart will show the basic statistics for that set of 
                            	data: 
                            </p>
                            <br/>
                            ...
                            <p> The <strong>more statistics</strong> link at the bottom of the table will display additional output related to the statistical method. </p>

														<!-- Commented out Nov 3rd, 2014 as there is no way (any more) of getting to the timeseries charts on our portal. -->
                            ...
                            <p>When the data for a parameter is collected at various points in time, a scatter plot will show each data value on the y a-xis 
                            		and the date/time the data was collected on the x-axis. </p> 
