                ...
                <div class="region region-content">              
                    ...
                    <div class="block block-system">
                        ...
                        <div id="top" class="content node">
                            ...
                            <p>Data for the charts are obtained from the IMPC phenotyping centers and from the <a href="http://www.europhenome.org/">
                            ...
                            <p>Charts are interactive so that you can adjust the view to your liking. Click on a legend to remove a set of data from the graph.
                            ...
                            <img src="img/graph-after-zoom.png" alt="Zoomed in chart here">
														...
														<p> Parts of the chart header are also interactive. Clicking on the pipeline and procedure links will take you to the IMPReSS page describing them. </p>
                            ...
                            <p>The data used to generate the charts can be downloaded in TSV or XLS formats from the buttons on the top of the page (<img src="img/graph-data-export.png"
                            ...
                            <table>
                                ...
                                <tr><td> pipelineName </td><td> Pipeline through which the phenotyping was done, e.g. EUMODIC pipelines </td></tr>
                                ...
                                <tr><td> geneAccession </td><td> Gene MGI accession id </td></tr>
                            ...
                            <br/>
                            <p> A <b>restful web service</b> (with <a href="api-help"> Documentation</a>) is also available for retrieving information
                            ...
                            <p>Where an observation can be measured on a continuous basis (e.g. red blood cell counts or tail length), we display them in a mixed box and scatter plot. 
                            	...
                            	The second set of columns contains scatter plots for the same sets of data. Hover over the box in the chart to see the basic statistics for that set of
                            	data.
                            </p>
                            <p>When the data for a parameter is collected at various points in time, a scatter plot shows each data value on the y-axis
                            ...
                            <dl>
                                ...
                                <dd>For the measured parameter, there is a significant effect, but there is not enough statistical power to determine sexual dimorphism</dd>
                            ...
                            <p> The <strong>more statistics</strong> link at the bottom of the table displays additional output related to the statistical method. </p>

                            <h3 id="time-graphs">Time Series Graphs</h3>
                            <img src="img/graph-time-series.png">
                            <p>Where an observation can be measured as a time series (e.g. mean blood glucose concentration), we display the data in a line chart and
                               scatter plot. The line chart will contain lines for wild-type and mutant data for female and for males.  The data points displayed are
                               the mean of all data collected at that timepoint and the whiskers indicate standard deviation. Hover over the points to see basic
