                            ...
                            <p>The statistical-result REST API provides access to the detailed output generated as part
                                of the statistical analysis process.</p>
                            ...
                            <ul class="task-list">
                                ...
                                <li> phenotyping pipeline (EUMODIC1, EUMODIC2, MGP, IMPC adult, IMPC embryonic, etc.)
                                </li>
                            ...
                            <p>The statistical-result REST API provides the fields described in the table below. Each
                                field may be used for restricting the set
                                of statistical-results you wish to receive. The full SOLR select syntax is available for
                                use in querying the REST API. See <a
                                        href="http://wiki.apache.org/solr/SolrQuerySyntax">http://wiki.apache.org/solr/SolrQuerySyntax</a>
                                and <a
                                        href="http://wiki.apache.org/solr/CommonQueryParameters">http://wiki.apache.org/solr/CommonQueryParameters</a>
                                for a
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>string</td>
                                    <td>The accession ID of the top level MP term obtained by interrogating the MP
                                        ontology
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>string</td>
                                    <td>The accession ID of all intermediate level MP terms obtained by interrogating
                                        the MP ontology
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>string</td>
                                    <td>The name of all intermediate level MP terms obtained by interrogating the MP
                                        ontology
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>If the result produced a phenotype call, this lists all the sexes for which the
                                        call is significant
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    <td>resource_id</td>
                                    <td>int</td>
                                    <td>The IMPC internal identifier of the resource responsible for producing the
                                        data
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>colony_id</td>
                                    <td>string</td>
                                    <td>Phenotyping center specific colony name of the line used to generate the data
                                    </td>
                                </tr>
                                <tr>
                                    <td>marker_symbol</td>
                                ...
                                <tr>
                                    ...
                                    <td>string</td>
                                    <td>The strategy used to select the control set (options are baseline_all or
                                        concurrent)
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>float</td>
                                    <td>The significance of the genotype effect to describe variation in the data <sup>[1]</sup>
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>boolean</td>
                                    <td>True/false if the significance of sex*genotype interaction is significant <sup>[1]</sup>
                                    </td>
                                </tr>
                                <tr>
                                    <td>interaction_effect_p_value</td>
                                    <td>float</td>
                                    <td>The significance of sex*genotype interaction to describe variation in the data
                                        <sup>[1]</sup></td>
                                </tr>
                                <tr>
                                    <td>female_ko_effect_p_value</td>
                                    <td>float</td>
                                    <td>If sex is significant, the significance of the female genotype <sup>[1]</sup>
                                    </td>
                                </tr>
                                <tr>
                                    <td>female_ko_effect_stderr_estimate</td>
                                    <td>float</td>
                                    <td>If sex is significant, the standard error estimate of the female genotype <sup>[1]</sup>
                                    </td>
                                </tr>
                                <tr>
                                    <td>female_ko_parameter_estimate</td>
                                    <td>float</td>
                                    <td>If sex is significant, the effect size estimate of the female genotype
                                        <sup>[1]</sup></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>float</td>
                                    <td>If sex is significant, the standard error estimate of the male genotype
                                        <sup>[1]</sup></td>
                                </tr>
                                <tr>
                                    <td>male_ko_parameter_estimate</td>
                                    <td>float</td>
                                    <td>If sex is significant, the effect size estimate of the male genotype
                                        <sup>[1]</sup></td>
                                </tr>
                                <tr>
        ...
        <span class="s1">'http://www.ebi.ac.uk/mi/impc/solr/statistical-result/select?q=*:*&amp;rows=10&amp;wt=json&indent=true'</span>
                            ...
                            <ul class="task-list">
                                <li><strong>statistical-result</strong> is the name of the Solr core service to query
                                </li>
                                <li><strong>select</strong> is the method used to query the Solr REST interface</li>
                                <li><strong>q=<em>*:*</em></strong> means querying everything without any filtering on
                                    any field
                                </li>
                                <li><strong>rows</strong> allows to limit the number of results returned. Note: if you
                                    do not specify the rows parameter, the default is 10 rows.
                                </li>
                                <li><strong>wt=json</strong> return the results in json format (csv is an alternate
                                    format
                                </li>
                                <li><strong>indent=1</strong> or <strong>indent=true</strong> indents the output into a
                            ...
                            <p>We will constrain the results by adding a condition to the <strong>q</strong> (query)
                                parameter using the specific
                                <strong>marker_symbol</strong> field. For Akt2, simply specify <strong>q=marker_symbol:Akt2</strong>
                            </p>
        ...
        <span class="s1">'http://www.ebi.ac.uk/mi/impc/solr/statistical-result/select?q=marker_symbol:Akt2&amp;wt=json&indent=true'</span>
                            ...
                            <p>More examples of how to use Solr to query and filter are available on the
                                <a href="${baseUrl}/documentation/data-access-api-genotype-phenotype">genotype-phenotype
                                    API</a> documentation page.</p>

                            <h3>URL examples</h3>

                            <p>The following are example URLs that you can paste into your browsers location bar. The
                                resulting documents will display like a web page.</p>
