    ...
    <main id="main" class="main" role="main">
        <div class="container-fluid">
            ...
            <div class="container single single--no-side">
                <div class="row">
                    <div class="col-12 white-bg">
                        <div class="page-content pt-5 pb-5">
                            <p>This is a paragraph of text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent viverra aliquet blandit. Nulla vulputate metus eget
                            diam tincidunt ornare.</p>
                            ...
                            <p>This is a paragraph with a <a href="https://google.co.uk">link to google</a>.</p>
                            ...
                            <p>This is a standard width image:
                            <img src="https://via.placeholder.com/350x150" />
                            </p>
                            
                            <p>This is a full width image:
                                <img class="img-full" src="https://via.placeholder.com/350x150" />
                            </p>

                            <p>This is a fluid width image:
                                <img class="img-fluid" src="https://via.placeholder.com/600x150" />
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div class="row text-center pt-5 pb-5 white-bg">
                    <div class="col-12 col-md-4">
                        This is 1/3 column
                    </div>
                    <div class="col-12 col-md-4">
