...
<t:genericpage>
    ...
    <jsp:attribute name="title">Viability charts for ${markerSymbol}</jsp:attribute>
    <jsp:attribute name="breadcrumb">&nbsp;&raquo; Statistics &raquo; <a
            href='${baseUrl}/genes/${mgiAccessionId}'>${markerSymbol}</a></jsp:attribute>
    ...
    <jsp:body>
        <div class="container data-heading">
            <div class="row row-shadow">
                <div class="col-12 no-gutters">
                    <h2>${markerSymbol} viability data chart</h2>
                </div>
            </div>
        </div>
        ...
        <c:forEach var="graphUrl" items="${allGraphUrlSet}" varStatus="graphUrlLoop">
            ...
            <div class="chart pb-5" id="chart${graphUrlLoop.count}" graphUrl="${baseUrl}/viabilitychart?${graphUrl}" id="divChart_${graphUrlLoop.count}">
        ...
        <script>
            ...
            $(document)
                .ready(function () {
                    ...
                    var params = window.location.href.split("/viabilitycharts?")[1]; //.split("&");
                    var paramList = window.location.href.split("/viabilitycharts?")[1].split("&");
