...
<div id="embryo-wt-expression-table" class="row justify-content-center">
                        ...
                        <tr>
                            ...
                            <td data-align="right">
                                <c:choose>
                                    ...
                                    <c:when test="${embryoWtAnatomyToRow[mapEntry.key].noTissueAvailable}">
                                        Unavailable
                                    </c:when>
...
<%--EXPRESSION IMAGES--%>
<%--<div id="embryo-wt-expression-images" class="mt-3">--%>
<%--    &lt;%&ndash;ACCORDION&ndash;%&gt;--%>
<%--    <div class="accordion expressionAccordion" id="embryoWtExpressionAccordion">--%>
<%--        <div>--%>
<%--            <div id="embryoWtHeadingWholemount">--%>
<%--                <h4 class="accordion-title" data-toggle="collapse" data-target="#embryoWtWholemountImages" aria-expanded="true" aria-controls="embryoWtWholemountImages">--%>
<%--                    Images of background staining in WT embryos--%>
<%--                    <i class="far fa-plus float-right"></i>--%>
<%--                </h4>--%>
<%--            </div>--%>
<%--            <div id="embryoWtWholemountImages" class="collapse" aria-labelledby="embryoWtHeadingWholemount" data-parent="#expressionAccordion">--%>
<%--                <c:choose>--%>
