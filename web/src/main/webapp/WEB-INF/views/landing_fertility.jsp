    ...
    <jsp:body>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <h5>
                        This page aggregates data about the IMPC fertility screen.
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <p>The following diagram represents the various biological system phenotypes associations for
                        genes linked to reproductive system phenotypes. The line thickness is correlated with the
                    ...
                    <script>
                        var mpTopLevelTerms = ["reproductive system phenotype"];
