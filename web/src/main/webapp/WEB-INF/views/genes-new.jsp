            ...
            <div class="region region-pinned">
	            ...
	            <div id="flyingnavi" class="block">
		            ...
		            <ul>
			            ...
			            <%--<c:if test="${not empty orthologousDiseaseAssociations || not empty phenotypicDiseaseAssociations}">--%>
				...
				<div class="content">
					<c:if class="node node-gene">
						...
						<div class="section">
							...
							<h2 class="title " id="section-associations">Phenotype associations for ${gene.markerSymbol}
                                    <span class="documentation"><a href='' id='mpPanel' class="fa fa-question-circle pull-right"></a></span>
						...
						<c:if test="${phenotypeStarted}">
							...
							<div class="section">
								<h2 class="title" id="heatmap">Pre-QC phenotype heatmap
									<span class="documentation"><a href='' id='preqcPanel' class="fa fa-question-circle pull-right"></a></span>
								</h2>
