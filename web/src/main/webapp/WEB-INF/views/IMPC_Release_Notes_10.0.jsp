    ...
    <div class="row">
        <div class="col-6">
            ...
            <div class="with-label">
                <span class="label">Statistical Package</span>
                <ul>
                    <li>PhenStat</li>
        ...
        <div class="half">
            ...
            <div class="with-label"><span class="label">Data access</span>
                <ul>
                    <li>Ftp site:&nbsp;<a href="ftp://ftp.ebi.ac.uk/pub/databases/impc/release-10.0">ftp://ftp.ebi.ac.uk/pub/databases/impc/release-10.0</a>
                    </li>
