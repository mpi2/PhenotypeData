...
<div class="row">
    ...
    <div class="col-md-6">
        ...
        <div>
            <h4>Data access</h4>
            <ul class="mt-0">
                <li>Ftp site:&nbsp;<a href="ftp://ftp.ebi.ac.uk/pub/databases/impc/release-7.0">ftp://ftp.ebi.ac.uk/pub/databases/impc/release-7.0</a></li>
    ...
    <h2>Phenotype Associations Overview</h2>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr><td>KMPC</td><td><a href="${baseUrl}/page-retired">Browse</a></td><td>IMPC_001</td></tr>
                <tr><td>MARC</td><td><a href="${baseUrl}/page-retired">Browse</a></td><td>IMPC_001</td></tr>
