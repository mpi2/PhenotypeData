...
<div class="row justify-content-end mt-3 mr-2">
    <div class="btn-group btn-group-toggle" data-toggle="buttons">
        <label class="btn btn-outline-primary btn-sm active">
            <input type="radio" name="options" id="expressionTableToggle" value="table" autocomplete="off" checked> Table
        </label>
        <label class="btn btn-outline-primary btn-sm">
            <input type="radio" name="options" id=" " autocomplete="off" value="anatogram"> Images
        </label>
    </div>
</div>
