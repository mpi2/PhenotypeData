...
<t:genericpage>
    ...
    <jsp:attribute name="breadcrumb">&nbsp;&raquo; <a href="${baseUrl}/biological-system">Biological Systems</a> &nbsp;&raquo; Embryo</jsp:attribute>
						...
						<h2>IMPC Embryo Phenotyping - Goals and Procedures</h2>
                            ...
                            <div class="inner">
								...
								<div class="half ">
                            		...
                            		<p class="onethird ">&nbsp;&nbsp;WT / <a href="${baseUrl}/imageComparator?acc=MGI:102806&parameter_stable_id=IMPC_GEO_050_001">Acvr2a</a> </p>
                            		<div class="clear"></div> 
