                    ...
                    <div class="row mb-3">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                All our results. Reports need to be filtered by a dedicated column, Life Stage (E9.5, E12.5, E15.5 and E18.5). Please check the README file or see documentation <a href="${cmsBaseUrl}/help/non-programmatic-data-access/">here</a>.
                            </li>
                            <li>
                                Using the REST API (see documentation <a href="${cmsBaseUrl}/help/programmatic-data-access/">here</a>)
                            </li>
                        </ul>
                    </div>
