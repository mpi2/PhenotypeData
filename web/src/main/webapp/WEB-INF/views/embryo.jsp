		...
		<div class="container">
					...
					<div class="row mb-5">
						...
						<div id="viabilityChart" class="col-6 align-items-center">
							<table class="table table-striped thead-light w-100">
								...
								<tr>
									<td></td>
									<td><a href="ftp://ftp.ebi.ac.uk/pub/databases/impc/latest/reports/viabilityReport.csv" style="text-decoration:none;" download> <i class="fa fa-download" alt="Download"></i> Download</a></td>
								</tr>
								</tbody>
							</table>
						</div>
			...
			<div class="row mb-5">
				<div class="col-12">
					...
					<p>With up to one third of knockout strains being embryonic lethal, a systematic unbaised phenotyping pipeline was established to perform morphologic and imaging evaluation of mutant embryos to define the primary perturbations that cause their death. From this important insights are gained into gene function.</p>
					<p>IMPC centers funded by the NIH Common fund mechanism are delivering the following for <b>All Lines</b>:</p>
						<ul>
						<li>Viability</li>
						<li>Heterozygote E12.5 Embryonic LacZ staining ( 2 mutant animals, wt reference images)</li>
					</ul>

					<p>For <b>All Embryonic Lethal Lines</b>, gross morphology is assessed at E12.5 to determine if defects occur earlier or later in development. A comprehensive imaging platform is then used to assess dysmorphology at the <b>most</b> appropriate stage:</p>
				...
				<div class="col-12">
					...
					<div class="row mb-5">
						<div class="col-6">
							...
							<p><a href="${baseUrl}/imageComparator?acc=MGI:1915138&anatomy_term=TS20%20embryo%20or%20Unassigned&parameter_stable_id=IMPC_ELZ_064_001">Tmem100</a></p>
							<p> The majority of IMPC knockout strains replace a critical protein coding exon with a LacZ gene expression reporter element. Heterozygote E12.5 embryos from IMPC strains are treated to determine in situ expression of the targeted gene.</p>
						...
						<div class="col-6">
							...
							<p>WT / <a href="${baseUrl}/imageComparator?acc=MGI:102806&parameter_stable_id=IMPC_GEO_050_001">Acvr2a</a> </p>
							<p>Gross morphology of embryos from lethal and subviable strains highlights which biological systems are impacted when the function of a gene is turned off. The developmental stage selected is determined by an initial assessment.</p>
			...
			<div class="row mb-5">
				<div class="col-12">
					...
					<div>
						<a class="btn btn-primary" href="${drupalBaseUrl}/embryoviewer/?mgi=MGI:2147810&pid=203&h=undefined&s=on&c=off&a=off&o=vertical&zoom=0&sb=600&wn=146521&wx=54&wy=66&wz=68&wl=0&wu=254&mn=129313&mx=52&my=68&mz=108&ml=0&mu=205">Tmem132a</a>
						<a class="btn btn-primary" href="${drupalBaseUrl}/embryoviewer/?mgi=MGI:1916804&mod=203&h=624&wt=klf7-tm1b-ic/16.5b_5553715&mut=klhdc2-tm1b-ic/21.1f_5578050&s=on&c=off&a=off&wx=64&wy=117&wz=178&mx=44&my=107&mz=154&wl=0&wu=255&ml=0&mu=255&o=vertical&zoom=0">Klhdc2</a>
						<a class="btn btn-primary" href="${drupalBaseUrl}/embryoviewer/?mgi=MGI:1195985&mod=203&h=561&wt=Population%20average&mut=AAPN_K1026-1-e15.5&s=off&c=off&a=on&wx=94&wy=64&wz=177&mx=94&my=70&mz=137&wl=0&wu=255&ml=0&mu=254&o=vertical&zoom=0&wto=jacobian&muto=none">Cbx4</a>
						<a class="btn btn-primary" href="${drupalBaseUrl}/embryoviewer/?mgi=MGI:102806&pid=203&h=569&s=on&c=off&a=off&o=vertical&zoom=0&sb=600&wn=ABIF_K1339-10-e15.5&wx=79&wy=107&wz=141&wl=0&wu=255&mn=ABIF_K1267-19-e15.5&mx=79&my=107&mz=142&ml=0&mu=255">Acvr2a</a>
