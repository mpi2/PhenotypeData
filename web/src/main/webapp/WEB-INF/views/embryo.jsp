            ...
            <div class="breadcrumbs clear row">
                ...
                <div class="col-12 d-none d-lg-block px-5 pt-5">
                    <aside>
                        ...
                        <strong style="text-transform: capitalize">Embryo</strong>
                    </aside>
                </div>
                            ...
                            <div class="container">
                                                    ...
                                                    <c:forEach var="row" items="${viabilityTable}">
                                                        <tr>
                                                            ...
                                                            <c:if test="${row.mpId != null}">
                                                                <td>
                                                                    <a href="${baseUrl}/phenotypes/${row.mpId}">${row.count}</a>
                                                                </td>
                                                            </c:if>
                                                            <c:if test="${row.mpId == null}">
                                                                <td>${row.count}</td>
                                ...
                                <div class="row mb-5">
                                    <div class="col-12">
                                        ...
                                        <p>With up to one third of knockout strains being embryonic lethal, a systematic
                                            unbaised
                                            phenotyping pipeline was established to perform morphologic and imaging
                                            evaluation of mutant
                                            embryos to define the primary perturbations that cause their death. From
                                            this important insights
                                            are gained into gene function.</p>
                                        <p>IMPC centers funded by the NIH Common fund mechanism are delivering the
                                            following for <b>All
                                                Lines</b>:</p>
                                        <ul>
                                            <li>Viability</li>
                                            <li>Heterozygote E12.5 Embryonic LacZ staining ( 2 mutant animals, wt
                                                reference images)
                                            </li>
                                        </ul>

                                        <p>For <b>All Embryonic Lethal Lines</b>, gross morphology is assessed at E12.5
                                            to determine if
                                            defects occur earlier or later in development. A comprehensive imaging
                                            platform is then used to
                                            assess dysmorphology at the <b>most</b> appropriate stage:</p>

                                        <table id="embryo_data_table" data-toggle="table" data-pagination="true"
                                               data-mobile-responsive="true"
                                               data-sortable="true" data-custom-sort="sortString" data-search="true"
                                        ...
                                        <p>In addition, the NIH is supporting in-depth phenotyping of embryonic lethal
                                            lines with three
                                            current awardees.</p>
                                        <p>
                                        ...
                                        <p><a href="https://www.vasci.umass.edu/research-faculty/jesse-mager">Jesse
                                            Mager, University of
                                            Massachusetts Amherst</a></p>
                                        <p><a href="https://www.mskcc.org/research-areas/labs/elizabeth-lacy">Elizabeth
                                            Lacy, Memorial Sloan
                                ...
                                <div class="row mb-5">
                                    <div class="col-12">
                                        ...
                                        <div class="row mb-5">
                                            <div class="col-md-6">
                                                <h3>Embryo LacZ</h3>
                                                <img class="img-fluid " src="${baseUrl}/img/Tmem100_het.jpeg"
                                                     height="200"/>
                                                <p>
                                                ...
                                                <p> The majority of IMPC knockout strains replace a critical protein
                                                    coding exon with a LacZ
                                                    gene expression reporter element. Heterozygote E12.5 embryos from
                                                    IMPC strains are
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <img class="img-fluid " src="${baseUrl}/img/Acvr2a_hom.jpeg"
                                                     height="200" style="width:auto"/>
                                                <p>WT / <a
                                                        href="${baseUrl}/imageComparator?acc=MGI:102806&parameter_stable_id=IMPC_GEO_050_001">Acvr2a</a>
                                                </p>
                                                <p>Gross morphology of embryos from lethal and subviable strains
                                                    highlights which biological
                                                    systems are impacted when the function of a gene is turned off. The
                                                    developmental stage
                                ...
                                <div class="row mb-5">
                                    <div class="col-12">
                                        ...
                                        <p> The embryonic and perinatal lethal pipeline comprises several 3D imaging
                                            modalities to quantify
                                            aberrant morphology that could not be determined by gross inspection. Images
                                            acquired by
                                        ...
                                        <div>
                                            ...
                                            <a class="btn btn-primary" href="${baseUrl}/embryo_imaging"> See all </a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-5">
                                    <div class="col-12">
                                        ...
                                        <div id="sliderDiv">
                                            <div id="slider">
                                                <div id="sliderHighlight" class="slider"
                                                     imgUrl="${baseUrl}/embryo/vignettes"></div>
                                                <div>
                                            ...
                                            <div id="sliderControl" class="sliderControl">
                                                <ul>
                                                    <li id="item0"><img class="img_fluid"
                                                                        src="${baseUrl}/img/vignettes/chtopPink.jpg"/>
                                                        <p class="embryo-caption"> Chtop has been shown to recruit the
                                                            histone-methylating
                                                            methylosome to genomic regions containing
                                                            5-Hydroxymethylcytosine, thus affecting gene expression.
                                                            Chtop mutants showed
                                                            complete preweaning lethality with
                                                            no homozygous pups observed. High resolution episcopic
                                                            microscopy (HREM)
                                                            imaging, revealed decreased number of
                                                            vertebrae, abnormal joint morphology and edema.
                                                            <t:vignetteLink geneId="MGI:1913761"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Chtop<tm1a(EUCOMM)Wtsi></t:formatAllele></p>
                                                    </li>
                                                    <li id="item1"><img class="img_fluid"
                                                                        src="${baseUrl}/img/vignettes/Kldhc2.png"/>
                                                        <p class="embryo-caption"> The Kldhc2 gene is located within a
                                                            locus linked to an
                                                            automsomal dominant disease that leads to fibro-fatty
                                                            replacement of right
                                                            ventricle myocardium leading to arrythmias (ARVD3 ; OMIM)
                                                            <t:vignetteLink geneId="MGI:1916804"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Klhdc2<tm1b(EUCOMM)Hmgu></t:formatAllele>
                                                        </p>
                                                    </li>
                                                    <li id="item2"><img class="img_fluid"
                                                                        src="${baseUrl}/img/vignettes/Acvr2aMicroCT.png"/>
                                                        <p class="embryo-caption">Activin receptor IIA is a receptor for
                                                            activins, which are
                                                        ...
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Acvr2a<tm1.1(KOMP)Vlcg></t:formatAllele></p>
                                                    </li>
                                                    <li id="item3"><img class="img_fluid"
                                                                        src="${baseUrl}/img/vignettes/cbx4.png"/>
                                                        <p class="embryo-caption">Chromobox 4 is in the polycomb protein
                                                            family that are key
                                                            regulators of transcription and is reported to be
                                                            upregulated in lung bud
                                                            formation and required for thymus development
                                                            <t:vignetteLink geneId="MGI:1195985"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Cbx4<tm1.1(KOMP)Vlcg></t:formatAllele></p>
                                                    </li>
                                                    <li id="item4"><img class="img_fluid"
                                                                        src="${baseUrl}/img/vignettes/tmem100.png"/>
                                                        <p class="embryo-caption">Transmembrane Protein 100 functions
                                                            downstream of the
                                                            BMP/ALK1 signaling pathway. Tmem100 mutants showed complete
                                                            preweaning lethality
                                                            and were also lethal at E12.5. <t:vignetteLink
                                                                    geneId="MGI:1915138"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Tmem100<tm1e.1(KOMP)Wtsi></t:formatAllele>
                                                        </p>
                                                    </li>
                                                    <li id="item5"><img class="img_fluid"
                                                                        src="${baseUrl}/img/vignettes/eye4.png"/>
                                                        <p class="embryo-caption"> Eyes absent transcriptional
                                                            coactivator and phosphatase 4
                                                            is associated with a variety of developmental defects
                                                            including hearing loss.
                                                            Eya4 mutants showed complete preweaning lethality with no
                                                            homozygous pups
                                                            observed. <t:vignetteLink
                                                                    geneId="MGI:1337104"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Eya4<tm1b(KOMP)Wtsi></t:formatAllele></p>
                                                    </li>
                                                    <li id="item6"><img class="img_fluid"
                                                                        src="${baseUrl}/img/vignettes/tox3MRI.png"/>
                                                        <p class="embryo-caption">Tox High Mobility Group Box Family
                                                            Member 3 is a member of
                                                            the HMG-box family involved in bending and unwinding DNA.
                                                            Tox3 mutants have
                                                            partial preweaning lethality with 1/3 of the pups dying
                                                            before P7.
                                                            <t:vignetteLink geneId="MGI:3039593"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Tox3<tm1b(KOMP)Mbp></t:formatAllele></p>
                                                    </li>
                                                    <li id="item7"><img class="img_fluid"
                                                                        src="${baseUrl}/img/vignettes/Rsph9Slides.png"/>
                                                        <p class="embryo-caption">Radial spoke head protein 9 is a
                                                        ...
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Rsph9<tm1.1(KOMP)Vlcg></t:formatAllele></p>
                                                    </li>

                                                    <li id="item8"><img class="img_fluid"
                                                                        src="${baseUrl}/img/vignettes/Pax7.png"/>
                                                        <p class="embryo-caption">Pax 7 is a nuclear transcription
                                                            factor with DNA-binding
                                                            activity via its paired domain. It is involved in
                                                            specification of the neural
                                                            crest and is an upstream regulator of myogenesis during
                                                            post-natal growth and
                                                            muscle regeneration in the adult. <t:vignetteLink
                                                                    geneId="MGI:97491"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Pax7<tm1.1(KOMP)Vlcg></t:formatAllele></p>
                                                    </li>

                                                    <li id="item9"><img class="img_fluid"
                                                                        src="${baseUrl}/img/vignettes/Svep1.jpg"/>
                                                        <p class="embryo-caption">Svep1 codes for an uncharacterized
                                                            protein named after the
                                                            multiple, extra-cellular domains identified in the sequence.
                                                            Homozygotes fail
                                                    ...
                                                    <li id="item10"><img class="img_fluid"
                                                                         src="${baseUrl}/img/vignettes/Strn3.jpg"/>
                                                        <p class="embryo-caption">Striatins act as both
                                                            calcium-dependent signaling proteins
                                                            and scaffolding proteins, linking calcium-sensing signaling
                                                            events with cellular
                                                            action. Lethality in Strn3 homozygotes occurs around E15.5.
                                                            <t:vignetteLink geneId="MGI:2151064"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Strn3<tm1b(KOMP)Wtsi/J></t:formatAllele></p>
                                                    </li>

                                                    <li id="item11"><img class="img_fluid"
                                                                         src="${baseUrl}/img/vignettes/Rab34.jpg"/>
                                                        <p class="embryo-caption">Rab34 is a member of the RAS oncogene
                                                            family, involved in
                                                            intracellular vesicle transport. Rab34 homozygotes are
                                                            subviable at E18.5.
                                                    ...
                                                    <li id="item12"><img class="img_fluid"
                                                                         src="${baseUrl}/img/vignettes/Cox7c.jpg"/>
                                                        <p class="embryo-caption">Cytochrome c oxidase subunit VIIc
                                                            (Cox7c) is a
                                                            nuclear-encoded regulatory component of cytochrome c
                                                            oxidase. Homozygous mutants
                                                            do not survive between E15.5 and E18.5. <t:vignetteLink
                                                                    geneId="MGI:103226"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Cox7c<tm1b(KOMP)Mbp></t:formatAllele></p>
                                                    </li>

                                                    <li id="item13"><img class="img_fluid"
                                                                         src="${baseUrl}/img/vignettes/Bloc1s2.jpg"/>
                                                        <p class="embryo-caption">Bloc1s2 functions in the formation of
                                                            lysosome-related
                                                            organelles through the BLOC-1 complex, with lethality
                                                            occurring in knockouts
                                                            around E15.5.<t:vignetteLink
                                                                    geneId="MGI:1920939"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Bloc1s2<tm1.1(KOMP)Mbp></t:formatAllele></p>
                                                    </li>

                                                    <li id="item14"><img class="img_fluid"
                                                                         src="${baseUrl}/img/vignettes/Slc39a8.png"/>
                                                        <p class="embryo-caption">Solute carrier (metal ion transporter)
                                                            family 39 member 8
                                                    ...
                                                    <li id="item15"><img class="img_fluid"
                                                                         src="${baseUrl}/img/vignettes/Kdm8.png"/>
                                                        <p class="embryo-caption">Lysine (K)-specific demethylase 8
                                                            (Kdm8) is predicted to
                                                            have dual functions as a histone demethylase and as a
                                                            protein hydroxylase and is
                                                            also known as Jmjd5. Tm1b mutants show developmental delay
                                                            and fail to turn at
                                                            E9.5.<t:vignetteLink
                                                                    geneId="MGI:19224285"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Kdm8<tm1b(EUCOMM)Wtsi></t:formatAllele></p>
                                                    </li>

                                                    <li id="item16"><img class="img_fluid"
                                                                         src="${baseUrl}/img/vignettes/Atg3.png"/>
                                                        <p class="embryo-caption">Autophagy related 3 (Atg3) mutants
                                                            show cardio-vascular
                                                            defects at E14.5.<t:vignetteLink
                                                                    geneId="MGI:1915091"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Atg3<tm1b(EUCOMM)Hmgu></t:formatAllele></p>
                                                    </li>

                                                    <li id="item17"><img class="img_fluid"
                                                                         src="${baseUrl}/img/vignettes/gfpt1.png"/>
                                                        <p class="embryo-caption">Glutamine:fructose-6-phosphate
                                                            amidotransferase 1 (Gfpt1)
                                                            mutants show developmental delay and fail to turn at
                                                            E9.5.<t:vignetteLink
                                                                    geneId="MGI:95698"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Gfpt1<tm1b(EUCOMM)Wtsi></t:formatAllele></p>
                                                    </li>
                                                    <li id="item18"><img class="img_fluid"
                                                                         src="${baseUrl}/img/vignettes/Gygmutants.png"/>
                                                        <p class="embryo-caption">Glycogenin is an enzyme that converts
                                                            glucose to glycogen.
                                                            Glycogenin catalyzes UDP-alpha-D-glucose + glycogenin
                                                            &rlhar; UDP +
                                                            alpha-D-glucosylglycogenin. The enzyme is a homodimer of 37
                                                            kDa subunits.
                                                            Mutations in human GYG1 are associated with Glyocgen Storage
                                                            Disease XV and
                                                            Polyglucosan Body Myopathy 2 (<a
                                                                    href="http://www.omim.org/entry/603942">OMIM</a>).
                                                            Homozygous null Gyg
                                                            mice die between birth and weaning but were found in normal
                                                            proportions at
                                                            E18.5. Mutants were indistinguishable from littermates at
                                                            E12.5, E15.5 or E18.5
                                                            but analysis of microCT images revealed obvious cardiac
                                                            abnormalities, enlarged
                                                            thymus and abnormal nervous system morphology. This is the
                                                            first reported Gyg
                                                            mouse mutant.
                                                            <t:vignetteLink geneId="MGI:1351614"></t:vignetteLink></p>
                                                        <p class="sliderTitle">
                                                            <t:formatAllele>Gyg<tm1b(KOMP)Wtsi></t:formatAllele></p>
                                                    </li>
                                                    <li id="item19"><img class="img_fluid"
                                                                         src="${baseUrl}/img/vignettes/Tmem132aE15.5 sag.png"/>
                                                        <p class="embryo-caption">
                                                            Transmembrane protein132a is transmembrane protein of
                                                            unknown function.
                                                            Homozygous null mutants were viable at normal proportions at
                                                            E15.5 and E18.5 but
                                                            showed obvious and severe defects that were readibly visible
                                                            by eye. Embryos had
                                                            abnormal limb morphology with syndactyly, spina bifida,
                                                            heart abnormalities.
                                        ...
                                        <p> These vignettes highlight the utility of embryo phenotyping pipeline and
                                            demonstrate how gross
                                            morphology, embryonic lacz expression, and high resolution 3D imaging
                                            provide insights into
                                            developmental biology. Clicking on an image will provide more
                                            information. </p>
                                    </div>
                                </div>
                                ...
                                <div class="row mb-5">
                                    <div class="col-12">
                                        ...
                                        <div><a href="${cmsBaseUrl}/impress"><img class="img-fluid"
                                                                                  src="${baseUrl}/img/embryo_impress.png"/>
                                        </a></div>
                                    </div>
                                </div>
