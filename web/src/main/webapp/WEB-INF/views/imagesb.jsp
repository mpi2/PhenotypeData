...
<t:genericpage>
	...
	<jsp:attribute name="breadcrumb">&nbsp;&raquo; <a href="${baseUrl}/search/images?kw=*">Images</a> &raquo; Results</jsp:attribute>
...
<jsp:body>
   ...
   <c:if test="${solrImagesError ne null}"><h4>There is an error the image index is down please contact the IMPC if this error persists</h4></c:if>
		...
		<c:if test="${imageCount ne 0}"><h1 class="title" id="top">${imageCount} image(s) for ${breadcrumbText}</h1></c:if>
<div  class="section">
		<div class="inner">
