...
<div class="row">
    ...
    <div class="col-6">
        ...
        <div>
            <h4>Data access</h4>
            <ul class="mt-0">
                <li>Ftp site:&nbsp;<a href="ftp://ftp.ebi.ac.uk/pub/databases/impc/release-4.2">ftp://ftp.ebi.ac.uk/pub/databases/impc/release-4.2</a></li>
    ...
    <div class="col-12">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    <td>UC Davis</td>
                    <td><a href="${baseUrl}/page-retired">Browse</a></td>
                    <td>UCD_001</td>
                </tr>
            </tbody>
        </table>
