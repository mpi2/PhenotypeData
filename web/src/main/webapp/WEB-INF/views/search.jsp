...
//				});
                ...
                $("ul.tabLabel > li a").each(function () {
                    ...
                    if (thisId == coreName) {
                        ...
                        $.fn.displayFacets(coreName, ${searchResult});
                        ...
                        if (coreName.indexOf('images') != -1) {
                            ...
                            if (showImgViewStr == "showImgView=false") {
                                ...
                                foundMsg = '<p>Found '
                                        + '<span id="resultCount">'
                                        + '<span id="annotCount">' + ${searchResult}.iTotalRecords + ' annotations / </span>'
                                        + '<a rel="nofollow" href="' + ${searchResult}.imgHref + '">' + ${searchResult}.imgCount + '</a> images'
                                        + '</span></div>';
                            } else {
                        ...
                        $('table#' + tableId).dataTable({
                            ...
                            "aaData": ${searchResult}.aaData, // array of objects
                            "iTotalRecords": ${searchResult}.iTotalRecords
                        ...
                        addPaginationControl(parentContainer, infoDivId, paginationDivId, ${searchResult});
                ...
                function addDownloadTool() {
                    ...
                    var total = ${searchResult}.iTotalRecords;
