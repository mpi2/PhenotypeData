                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <c:if test="${not empty summary['status_mice']['orders']}">
                                        <a id="mice_order_contact_button" class="btn btn-lg" href="#mice_block"> <i
                                    ...
                                    <c:if test="${not empty summary['status_mice']['details']}">
                                        <a class="btn btn-lg" href="${summary['status_mice']['details'][0]}"> <i
                                ...
                                <td>
                                    <c:if test="${not empty other_available_alleles_with_mice}">
                                        ...
                                        <c:forEach var="allele" items="${other_available_alleles_with_mice.keySet()}"
                                                   varStatus="status">
                                            <a href="${baseUrl}/alleles/${acc}/${other_available_alleles_with_mice[allele]['allele_name']}
                                            <c:if test="${bare == true}">?bare=true</c:if>" class="<c:if
                                                test="${other_available_alleles_with_mice[allele]['mice_available'] == 'true' }">status done"</c:if>
                                            <c:if test="${other_available_alleles_with_mice[allele]['mice_available'] == 'false' }">status inprogress"</c:if> oldtitle="${other_available_alleles_with_mice[allele]['allele_name']}"><span>${other_available_alleles_with_mice[allele]['allele_name_suffix']}</span></a>
                                        </c:forEach>
                                    </c:if>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <c:if test="${not empty summary['status_es_cells']['orders']}">
                                        <a id="es_cell_order_contact_button" class="btn btn-lg" href="#es_cell_block">
                                    ...
                                    <c:if test="${not empty summary['status_es_cells']['details']}">
                                        <a class="btn btn-lg" href="${summary['status_es_cells']['details'][0]}"> <i
                                                class="fa  fa-envelope"></i> DETAILS </a>
                                    </c:if>
                                ...
                                <td>
                                    <c:if test="${not empty other_available_alleles_with_es_cells}">
                                        ...
                                        <c:forEach var="allele"
                                                   items="${other_available_alleles_with_es_cells.keySet()}"
                                                   varStatus="status">
                                            <a href="${baseUrl}/alleles/${acc}/${other_available_alleles_with_es_cells[allele]['allele_name']}
                                            <c:if test="${bare == true}">?bare=true</c:if>" class="<c:if
                                                test="${other_available_alleles_with_es_cells[allele]['es_cells_available'] == 'true' }">status done"</c:if>
                                            <c:if test="${other_available_alleles_with_es_cells[allele]['es_cells_available'] == 'false' }">status inprogress"</c:if> oldtitle="${other_available_alleles_with_es_cells[allele]['allele_name']}"><span>${other_available_alleles_with_es_cells[allele]['allele_name_suffix']}</span></a>
                                        </c:forEach>
                                    </c:if>
                                </td>
                            </tr>
