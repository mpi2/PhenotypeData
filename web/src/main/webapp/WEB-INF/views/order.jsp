        							...
        							<thead>
        		 					...
        		 					<tbody>
 										<c:forEach var="entry" items="${productsByName}">
 											...
 											<tr><td><img src="img/rep_icons/${fn:toLowerCase(entry.key)}.jpg" alt="${entry.key}"  width="100px" onerror="this.style.display='none';console.log(this.parentElement.parentElement.innerHTML='${entry.key}')" /></td><td>
