		...
		<div class="container">
			...
			<div class="row">
				<div class="col-12">
					...
					<p>
						<a href="http://bit.ly/IMPCDeafness">A large scale hearing loss screen reveals an extensive unexplored genetic landscape for auditory dysfunction<br/>
					...
					<p>Press releases:
						...
						<a href="http://bit.ly/DeafnessNewsStory">IMPC</a>
					</p>

					<h3>Methods</h3>
					<p>Response data from the <a href="http://www.mousephenotype.org/impress/protocol/149/7">Auditory
						Brain Stem response (ABR)</a> test was used – hearing at five frequencies, 6kHz, 12kHz, 18kHz, 24kHz and
					...
					<h3>Gene table</h3>
					<p>
						<a href="https://static-content.springer.com/esm/art%3A10.1038%2Fs41467-017-00595-4/MediaObjects/41467_2017_595_MOESM1_ESM.pdf">Supplementary Material</a>
					</p>
