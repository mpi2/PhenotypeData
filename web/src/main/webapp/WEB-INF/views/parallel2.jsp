...
<t:genericpage>
    ...
    <jsp:body>
			...
			<div class="content">
				<div class="section"> 
					<h2 class="title" id="parallel-title">Gene KO effect comparator <span class="documentation" ><a href='' id='parallelPanel' class="fa fa-question-circle pull-right"></a></span> </h2>
					<div class="inner">
						<p>
						...
						More information about the statistical methods used is available in the statistics documentation.
						</p> <br/>
