    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-6 footer-text">
                ...
                <p><strong><br />
                    <a href="https://www.mousephenotypetest.org/about-impc/accessibility-cookies/">Accessibility &amp; Cookies</a></strong><br />
                    <a href="https://www.mousephenotypetest.org/about-impc/terms-of-use/"><strong>Terms of use</strong></a></p>
            </div>

            <div class="col-12 col-md-3 footer-nav">
                <div class="menu-main-nav-container"><ul id="menu-main-nav-1" class="menu"><li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-16"><a href="https://www.mousephenotypetest.org/about-impc/">About IMPC</a></li>
                    <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-17"><a href="https://www.mousephenotypetest.org/understanding-the-data/">Data</a></li>
