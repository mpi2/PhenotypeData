                    ...
                    <div class="col-12 col-md-8">
                        <div class="portal-search pb-5 mb-5 mt-5">
                            <div class="portal-search__tabs">
                                <a id="geneSearchTab" data-type="gene" class="portalTab left-shadow <c:if test="${param.type != 'phenotype' and !isPhenotypePage}">active</c:if>" href="${baseUrl}/search">Genes</a>
