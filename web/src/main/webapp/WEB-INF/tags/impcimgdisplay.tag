...
<%@ attribute name="impcMediaBaseUrl" required="true" %>
        ...
        <a href="${impcMediaBaseUrl}/render_image/${img.omeroId}" class="fancybox" fullRes="${impcMediaBaseUrl}/${img.omeroId}"><img src="${impcMediaBaseUrl}/render_birds_eye_view/${img.omeroId}/"></a>
                                                <div class="caption">
