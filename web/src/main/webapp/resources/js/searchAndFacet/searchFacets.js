...
(function ($) {
    ...
    /**
     * Handling of facets for the disease page drive by the new phenodigm core
     *     
     * This is largely based on displayDiseaseFacet, but with slightly different
     * faceting settings.
     * 
     * Currently unused, this function can replace displayDisease1Facet after
     * search switches from the disease core to the phenodigm core.
     * 
     * @param {type} json
     * @returns {undefined}
     */
