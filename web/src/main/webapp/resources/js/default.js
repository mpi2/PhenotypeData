...
//	});
	...
	$('.fancybox').fancybox({'type' : 'image',
	    ...
	    afterLoad: function() {
	        this.title = '<a href="' + this.fullRes + '"><i class="fa fa-download"></i> Download this image in high resolution</a>'+' <a href="' + this.original + '"><i class="fa fa-download"></i> Download this image in original format</a>'+this.title;
	    },
	    helpers : {
	        title: {
	            type: 'inside'
