...
public interface ImagesSolrDao {
	...
	public abstract List<String> getIdsForKeywordsSearch(String query, int start, int length) throws SolrServerException;
	...
	public QueryResponse getFilteredDocsForQuery(String query, List<String> filterField, String qf, String defType, int start, int length)
			throws SolrServerException;
