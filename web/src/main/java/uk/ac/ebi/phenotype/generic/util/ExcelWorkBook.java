...
public class ExcelWorkBook {
	...
	public ExcelWorkBook(String[] titles, List<String> noTitleRows, String fileName, String filters) throws URISyntaxException {
		...
		sheet.setFitToPage(true);
		sheet.setHorizontallyCenter(true);
		sheet.createFreezePane(0,2); // freeze first two row when scroll: always sees the header

		XSSFRow headerRow0 = sheet.createRow(0);
		XSSFCell headerCellFilter;
		headerCellFilter = headerRow0.createCell(0);
		headerCellFilter.setCellValue(filters);
		headerCellFilter.setCellStyle(style);
