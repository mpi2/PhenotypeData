 ...
 */
public class CreateGenericSpecimenXml extends Create3iXmls implements CommandLineRunner {

    private String outFilename;
    private String inFilename;

    public static void main(String[] args) throws Exception {
        SpringApplication app = new SpringApplication(CreateGenericSpecimenXml.class);
    ...
    private void run() throws DataLoadException {
        ...
        try {
            // Save to file
            XMLUtils.marshall(CreateGenericSpecimenXml.CONTEXT_PATH, centreSpecimenSet, outFilename);
