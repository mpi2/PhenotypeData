 ...
 */
public class CreateSlmAgsExperimentXml extends Create3iXmls implements CommandLineRunner {

    private String outFilename;
    private String inFilename;

    @Value("${n_slm_ags_rows_per_mouse}")
    private int nRowsPerMouse;

    public static void main(String[] args) throws Exception {
        SpringApplication app = new SpringApplication(CreateSlmAgsExperimentXml.class);
    ...
    private void run() throws DataLoadException {
        ...
        try {
            // Save to file
            XMLUtils.marshall(CreateSlmAgsExperimentXml.CONTEXT_PATH, centreProcedureSet, outFilename);
