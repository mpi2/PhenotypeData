 ...
 */
public class CreateTriExperimentXml extends Create3iXmls implements CommandLineRunner {

    private String outFilename;
    private String inFilename;

    @Value("${n_tri_rows_per_mouse}")
    private int nRowsPerMouse;

    public static void main(String[] args) throws Exception {
        SpringApplication app = new SpringApplication(CreateTriExperimentXml.class);
    ...
    private void run() throws DataLoadException {
        ...
        centreProcedure.setPipeline("TRC_001");
        ...
        try {
            // Save to file
            XMLUtils.marshall(CreateTriExperimentXml.CONTEXT_PATH, centreProcedureSet, outFilename);
