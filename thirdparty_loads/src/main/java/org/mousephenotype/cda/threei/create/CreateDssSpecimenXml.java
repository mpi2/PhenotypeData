 ...
 */
public class CreateDssSpecimenXml extends Create3iXmls implements CommandLineRunner {

    private String outFilename;
    private String inFilename;

    public static void main(String[] args) throws Exception {
        SpringApplication app = new SpringApplication(CreateDssSpecimenXml.class);
    ...
    private void run() throws DataLoadException {
        ...
        while (reader.hasNext()) {
            ...
            if (nRowsForMouse > 0) {
                ...
                try {
                    ...
                    // STRAIN_MGI_ID is in row 28 (28-1=27) of ANA sheet,
                    // but row 29 for DSS (called MGI_ID in DSS)
        ...
        try {
            // Save to file
            XMLUtils.marshall(CreateDssSpecimenXml.CONTEXT_PATH, centreSpecimenSet, outFilename);
