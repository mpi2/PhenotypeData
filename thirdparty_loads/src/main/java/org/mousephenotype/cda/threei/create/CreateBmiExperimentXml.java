 ...
 */
public class CreateBmiExperimentXml extends Create3iXmls implements CommandLineRunner {

    private String outFilename;
    private String inFilename;

    @Value("${n_bmi_rows_per_mouse}")
    private int nRowsPerMouse;

    public static void main(String[] args) throws Exception {
        SpringApplication app = new SpringApplication(CreateBmiExperimentXml.class);
    ...
    private void run() throws DataLoadException {
        ...
        while (reader.hasNext()) {
            ...
            for (String[] rowResult : rowsForMouse) {
                ...
                switch (parameterImpressId) {
                    // procedureMetadata
                    case "MGP_BMI_038_001" : case "MGP_BMI_039_001" : 
                    case "MGP_BMI_040_001" : case "MGP_BMI_041_001" :
                    case "MGP_BMI_042_001" : case "MGP_BMI_043_001" :
        ...
        try {
            // Save to file
            XMLUtils.marshall(CreateBmiExperimentXml.CONTEXT_PATH, centreProcedureSet, outFilename);
