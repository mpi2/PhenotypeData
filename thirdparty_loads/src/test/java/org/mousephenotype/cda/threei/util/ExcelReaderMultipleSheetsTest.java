 ...
 * Test that it can read from multiple sheets without getting confused
 */
@RunWith(SpringJUnit4ClassRunner.class)
@TestPropertySource(locations = {"file:${user.home}/configfiles/${profile:dev}/test.properties"})
public class ExcelReaderMultipleSheetsTest {
    ...
    @Before
    public void ExcelReaderAnaTestSeup() throws IOException {
        Resource resource = new ClassPathResource("threei/tempAnaThreeSheets.xlsx");
