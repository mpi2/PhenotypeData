...
public class HpOntologyDAO extends OntologyDAO {
    ...
    public final List<List<String>> getDescendentGraphs(String id) {
        ...
        String query =
            "SELECT *\n"
          + "FROM hp_node_subsumption_fullpath_concat\n"
    ...
    protected final void populateAllTerms() throws SQLException {
        String query =
          ...
          + "FROM hp_node2term n2t\n"
          + "LEFT OUTER JOIN hp_term_infos ti ON ti.term_id = n2t.term_id\n"
          + "WHERE n2t.term_id != 'HP:0000001'\n"
    ...
    protected void populateAncestorMap() throws SQLException {
        String query =
            "SELECT *\n"
          + "FROM hp_node_backtrace_fullpath\n";
