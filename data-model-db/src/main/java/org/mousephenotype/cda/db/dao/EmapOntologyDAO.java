...
public class EmapOntologyDAO extends OntologyDAO {
    ...
    protected void populateAncestorMap() throws SQLException {
        ...
        String query =
            "SELECT *\n"
          + "FROM emap_node_backtrace_fullpath\n";
    ...
    private int getTopLevelTermIdCount(String termId) {
        ...
        String query =
          ...
          + "FROM ontodb_komp2.emap_node_2_selected_top_level_mapping stlm\n"
          + "WHERE node_id IN (\n"
          + "        SELECT DISTINCT child_node_id FROM ontodb_komp2.emap_node_subsumption_fullpath sf\n"
          + "    WHERE sf.node_id IN (\n"
