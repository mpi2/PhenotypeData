 ...
 * License.
 *******************************************************************************/
package org.mousephenotype.cda.pojo;
...
public class Parameter extends PipelineEntry {
	...
	/**
     * @param procedures the procedure to set
     */
    ...
    /**
     * Add a new procedure to the parameter
     * @param procedure
     */
	...
	/**
	 * @param derived the derivedFlag to set
	 */
	...
	/**
	 * @param option add an option to set
	 */
	...
	/**
	 * @param increments the increment to set
	 */
	...
	/**
	 * @param annotation add an annotation to set
	 */
	...
	/**
	 * @param eqAnnotation add an eqAnnotation to set
	 */
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((dataAnalysisNotes == null) ? 0 : dataAnalysisNotes
						.hashCode());
		result = prime * result
				+ ((datatype == null) ? 0 : datatype.hashCode());
		result = prime * result + (derivedFlag ? 1231 : 1237);
		result = prime * result
				+ ((eqAnnotations == null) ? 0 : eqAnnotations.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (annotations == null) {
			...
			return false;
		if (dataAnalysisNotes == null) {
			if (other.dataAnalysisNotes != null)
				return false;
		} else if (!dataAnalysisNotes.equals(other.dataAnalysisNotes))
			return false;
		if (datatype == null) {
		...
		if (derivedFlag != other.derivedFlag)
			return false;
		if (eqAnnotations == null) {
			if (other.eqAnnotations != null)
				return false;
		} else if (!eqAnnotations.equals(other.eqAnnotations))
			return false;
		if (formula == null) {
